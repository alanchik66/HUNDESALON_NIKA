...
(function initPriceCatalog(global) {
  ...
  const breedNames = {
    'affenpinscher': { de: 'Affenpinscher', en: 'Affenpinscher', ru: 'Аffenpinscher', uk: 'Аffenpinscher' },
    ...
    'american-staffordshire-terrier': { de: 'American Staffordshire Terrier', en: 'American Staffordshire Terrier', ru: 'Американский стaffordshire terrier', uk: 'Американський стaffordshire terrier' },
    ...
    'bedlington-terrier': { de: 'Bedlington Terrier', en: 'Bedlington Terrier', ru: 'Бедlington terrier', uk: 'Bedlington terrier' },
    ...
    'borzoi': { de: 'Barsoi', en: 'Borzoi', ru: 'Русская пsovaya borzaya', uk: 'Русська psovaya borzaya' },
    'boston-terrier': { de: 'Boston Terrier', en: 'Boston Terrier', ru: 'Бoston terrier', uk: 'Boston terrier' },
    ...
    'bullmastiff': { de: 'Bullmastiff', en: 'Bullmastiff', ru: 'Бульмастiff', uk: 'Бульмастiff' },
    'cairn-terrier': { de: 'Cairn Terrier', en: 'Cairn Terrier', ru: 'Керн-терьер', uk: 'Керн-тер\'єр' },
    'cavalier-king-charles-spaniel': { de: 'Cavalier King Charles Spaniel', en: 'Cavalier King Charles Spaniel', ru: 'Кавалер кинг Charles spaniel', uk: 'Кавалер кинг Charles spaniel' },
    'chihuahua': { de: 'Chihuahua', en: 'Chihuahua', ru: 'Чихуахua', uk: 'Чихуахua' },
    ...
    'dalmatian': { de: 'Dalmatiner', en: 'Dalmatian', ru: 'Дalmatin', uk: 'Dalmatin' },
    'dobermann': { de: 'Dobermann', en: 'Dobermann', ru: 'Доберман', uk: 'Доберман' },
    'dogue-de-bordeaux': { de: 'Dogue de Bordeaux', en: 'Dogue de Bordeaux', ru: 'Dogue de Bordeaux', uk: 'Dogue de Bordeaux' },
    'english-bulldog': { de: 'Englische Bulldogge', en: 'English Bulldog', ru: 'Английский бульdog', uk: 'Англійський бульdog' },
    ...
    'english-springer-spaniel': { de: 'English Springer Spaniel', en: 'English Springer Spaniel', ru: 'Английский springer spaniel', uk: 'English springer spaniel' },
    'flat-coated-retriever': { de: 'Flat-Coated Retriever', en: 'Flat-Coated Retriever', ru: 'Flat-coated retriever', uk: 'Flat-coated retriever' },
    'fox-terrier': { de: 'Foxterrier', en: 'Fox Terrier', ru: 'Фокsterrier', uk: 'Fox terrier' },
    'french-bulldog': { de: 'Französische Bulldogge', en: 'French Bulldog', ru: 'French bulldog', uk: 'French bulldog' },
    'german-shepherd': { de: 'Deutscher Schäferhund', en: 'German Shepherd', ru: 'Немецкая овчарка', uk: 'Німецька вівчарка' },
    'german-shorthaired-pointer': { de: 'Deutsch Kurzhaar', en: 'German Shorthaired Pointer', ru: 'Немецкий kurzhaar', uk: 'German shorthaired pointer' },
    ...
    'golden-retriever': { de: 'Golden Retriever', en: 'Golden Retriever', ru: 'Golden retriever', uk: 'Golden retriever' },
    'great-dane': { de: 'Deutsche Dogge', en: 'Great Dane', ru: 'Немецкий dog', uk: 'Great dane' },
    'greyhound': { de: 'Greyhound', en: 'Greyhound', ru: 'Greyhound', uk: 'Greyhound' },
    'havanese': { de: 'Havaneser', en: 'Havanese', ru: 'Havanese', uk: 'Havanese' },
    'hovawart': { de: 'Hovawart', en: 'Hovawart', ru: 'Hovawart', uk: 'Hovawart' },
    'irish-setter': { de: 'Irish Setter', en: 'Irish Setter', ru: 'Irish setter', uk: 'Irish setter' },
    'irish-wolfhound': { de: 'Irish Wolfhound', en: 'Irish Wolfhound', ru: 'Irish wolfhound', uk: 'Irish wolfhound' },
    'jack-russell-terrier': { de: 'Jack Russell Terrier', en: 'Jack Russell Terrier', ru: 'Jack Russell terrier', uk: 'Jack Russell terrier' },
    'king-charles-spaniel': { de: 'King Charles Spaniel', en: 'King Charles Spaniel', ru: 'King Charles spaniel', uk: 'King Charles spaniel' },
    'komondor': { de: 'Komondor', en: 'Komondor', ru: 'Komondor', uk: 'Komondor' },
    'kuvasz': { de: 'Kuvasz', en: 'Kuvasz', ru: 'Kuvasz', uk: 'Kuvasz' },
    'labrador-retriever': { de: 'Labrador Retriever', en: 'Labrador Retriever', ru: 'Labrador retriever', uk: 'Labrador retriever' },
    'lagotto-romagnolo': { de: 'Lagotto Romagnolo', en: 'Lagotto Romagnolo', ru: 'Lagotto romagnolo', uk: 'Lagotto romagnolo' },
    'leonberger': { de: 'Leonberger', en: 'Leonberger', ru: 'Leonberger', uk: 'Leonberger' },
    'lhasa-apso': { de: 'Lhasa Apso', en: 'Lhasa Apso', ru: 'Lhasa apso', uk: 'Lhasa apso' },
    'maltese': { de: 'Malteser', en: 'Maltese', ru: 'Мальтезе', uk: 'Мальтезе' },
    'manchester-terrier': { de: 'Manchester Terrier', en: 'Manchester Terrier', ru: 'Manchester terrier', uk: 'Manchester terrier' },
    'mastiff': { de: 'Mastiff', en: 'Mastiff', ru: 'Mastiff', uk: 'Mastiff' },
    'miniature-pinscher': { de: 'Zwergpinscher', en: 'Miniature Pinscher', ru: 'Miniature pinscher', uk: 'Miniature pinscher' },
    'miniature-schnauzer': { de: 'Zwergschnauzer', en: 'Miniature Schnauzer', ru: 'Miniature schnauzer', uk: 'Miniature schnauzer' },
    'mudi': { de: 'Mudi', en: 'Mudi', ru: 'Mudi', uk: 'Mudi' },
    'newfoundland': { de: 'Neufundländer', en: 'Newfoundland', ru: 'Ньюfaundlend', uk: 'Newfoundland' },
    'norfolk-terrier': { de: 'Norfolk Terrier', en: 'Norfolk Terrier', ru: 'Norfolk terrier', uk: 'Norfolk terrier' },
    'norwich-terrier': { de: 'Norwich Terrier', en: 'Norwich Terrier', ru: 'Norwich terrier', uk: 'Norwich terrier' },
    'old-english-sheepdog': { de: 'Bobtail', en: 'Old English Sheepdog', ru: 'Old English sheepdog', uk: 'Old English sheepdog' },
    'papillon': { de: 'Papillon', en: 'Papillon', ru: 'Papillon', uk: 'Papillon' },
    'parson-russell-terrier': { de: 'Parson Russell Terrier', en: 'Parson Russell Terrier', ru: 'Parson Russell terrier', uk: 'Parson Russell terrier' },
    'pekingese': { de: 'Pekingese', en: 'Pekingese', ru: 'Pekingese', uk: 'Pekingese' },
    'pomeranian': { de: 'Zwergspitz (Pomeranian)', en: 'Pomeranian', ru: 'Pomeranian', uk: 'Pomeranian' },
    'poodle-toy': { de: 'Toypudel', en: 'Toy Poodle', ru: 'Toy poodle', uk: 'Toy poodle' },
    'poodle-miniature': { de: 'Zwergpudel', en: 'Miniature Poodle', ru: 'Miniature poodle', uk: 'Miniature poodle' },
    'poodle-medium': { de: 'Kleinpudel', en: 'Medium Poodle', ru: 'Medium poodle', uk: 'Medium poodle' },
    'poodle-standard': { de: 'Großpudel', en: 'Standard Poodle', ru: 'Standard poodle', uk: 'Standard poodle' },
    'portuguese-water-dog': { de: 'Portugiesischer Wasserhund', en: 'Portuguese Water Dog', ru: 'Portuguese water dog', uk: 'Portuguese water dog' },
    'pug': { de: 'Mops', en: 'Pug', ru: 'Mops', uk: 'Mops' },
    'puli': { de: 'Puli', en: 'Puli', ru: 'Puli', uk: 'Puli' },
    'rhodesian-ridgeback': { de: 'Rhodesian Ridgeback', en: 'Rhodesian Ridgeback', ru: 'Rhodesian ridgeback', uk: 'Rhodesian ridgeback' },
    'rottweiler': { de: 'Rottweiler', en: 'Rottweiler', ru: 'Rottweiler', uk: 'Rottweiler' },
    'rough-collie': { de: 'Langhaarcollie', en: 'Rough Collie', ru: 'Rough collie', uk: 'Rough collie' },
    'samoyed': { de: 'Samojede', en: 'Samoyed', ru: 'Samoyed', uk: 'Samoyed' },
    'schnauzer-standard': { de: 'Mittelschnauzer', en: 'Standard Schnauzer', ru: 'Standard schnauzer', uk: 'Standard schnauzer' },
    'schnauzer-giant': { de: 'Riesenschnauzer', en: 'Giant Schnauzer', ru: 'Giant schnauzer', uk: 'Giant schnauzer' },
    'scottish-terrier': { de: 'Scottish Terrier', en: 'Scottish Terrier', ru: 'Scottish terrier', uk: 'Scottish terrier' },
    'shar-pei': { de: 'Shar-Pei', en: 'Shar-Pei', ru: 'Shar-Pei', uk: 'Shar-Pei' },
    'shetland-sheepdog': { de: 'Sheltie', en: 'Shetland Sheepdog', ru: 'Sheltie', uk: 'Sheltie' },
    'shiba-inu': { de: 'Shiba Inu', en: 'Shiba Inu', ru: 'Shiba inu', uk: 'Shiba inu' },
    'shih-tzu': { de: 'Shih Tzu', en: 'Shih Tzu', ru: 'Shih tzu', uk: 'Shih tzu' },
    'siberian-husky': { de: 'Sibirischer Husky', en: 'Siberian Husky', ru: 'Siberian husky', uk: 'Siberian husky' },
    'soft-coated-wheaten-terrier': { de: 'Soft Coated Wheaten Terrier', en: 'Soft Coated Wheaten Terrier', ru: 'Soft coated wheaten terrier', uk: 'Soft coated wheaten terrier' },
    'st-bernard': { de: 'Bernhardiner', en: 'St. Bernard', ru: 'St. Bernard', uk: 'St. Bernard' },
    'staffordshire-bull-terrier': { de: 'Staffordshire Bullterrier', en: 'Staffordshire Bull Terrier', ru: 'Staffordshire bull terrier', uk: 'Staffordshire bull terrier' },
    'tibetan-terrier': { de: 'Tibet Terrier', en: 'Tibetan Terrier', ru: 'Tibetan terrier', uk: 'Tibetan terrier' },
    'vizsla': { de: 'Vizsla', en: 'Vizsla', ru: 'Vizsla', uk: 'Vizsla' },
    'weimaraner': { de: 'Weimaraner', en: 'Weimaraner', ru: 'Weimaraner', uk: 'Weimaraner' },
    'west-highland-white-terrier': { de: 'West Highland White Terrier', en: 'West Highland White Terrier', ru: 'West highland white terrier', uk: 'West highland white terrier' },
    'whippet': { de: 'Whippet', en: 'Whippet', ru: 'Whippet', uk: 'Whippet' },
    'yorkshire-terrier': { de: 'Yorkshire Terrier', en: 'Yorkshire Terrier', ru: 'Йоркширский терьер', uk: 'Йоркширський тер\'єр' },
    abyssinian: { de: 'Abessiner', en: 'Abyssinian', ru: 'Abessiner', uk: 'Abessiner' },
    'american-shorthair': { de: 'American Shorthair', en: 'American Shorthair', ru: 'American shorthair', uk: 'American shorthair' },
    bengal: { de: 'Bengal', en: 'Bengal', ru: 'Bengal', uk: 'Bengal' },
    birman: { de: 'Heilige Birma', en: 'Birman', ru: 'Birman', uk: 'Birman' },
    'british-shorthair': { de: 'Britisch Kurzhaar', en: 'British Shorthair', ru: 'British shorthair', uk: 'British shorthair' },
    burmese: { de: 'Burma', en: 'Burmese', ru: 'Burmese', uk: 'Burmese' },
    'devon-rex': { de: 'Devon Rex', en: 'Devon Rex', ru: 'Devon rex', uk: 'Devon rex' },
    'domestic-shorthair': { de: 'Hauskatze (Kurzhaar)', en: 'Domestic shorthair cat', ru: 'Domestic shorthair cat', uk: 'Domestic shorthair cat' },
    'domestic-longhair': { de: 'Hauskatze (Langhaar)', en: 'Domestic longhair cat', ru: 'Domestic longhair cat', uk: 'Domestic longhair cat' },
    'european-shorthair': { de: 'Europäisch Kurzhaar', en: 'European Shorthair', ru: 'European shorthair', uk: 'European shorthair' },
    'exotic-shorthair': { de: 'Exotisch Kurzhaar', en: 'Exotic Shorthair', ru: 'Exotic shorthair', uk: 'Exotic shorthair' },
    'maine-coon': { de: 'Maine Coon', en: 'Maine Coon', ru: 'Maine coon', uk: 'Maine coon' },
    'norwegian-forest-cat': { de: 'Norwegische Waldkatze', en: 'Norwegian Forest Cat', ru: 'Norwegian forest cat', uk: 'Norwegian forest cat' },
    'oriental-shorthair': { de: 'Orientalisch Kurzhaar', en: 'Oriental Shorthair', ru: 'Oriental shorthair', uk: 'Oriental shorthair' },
    persian: { de: 'Perser', en: 'Persian', ru: 'Perser', uk: 'Perser' },
    ragdoll: { de: 'Ragdoll', en: 'Ragdoll', ru: 'Ragdoll', uk: 'Ragdoll' },
    'russian-blue': { de: 'Russisch Blau', en: 'Russian Blue', ru: 'Russian blue', uk: 'Russian blue' },
    savannah: { de: 'Savannah', en: 'Savannah', ru: 'Savannah', uk: 'Savannah' },
    'scottish-fold': { de: 'Schottische Faltohrkatze', en: 'Scottish Fold', ru: 'Scottish fold', uk: 'Scottish fold' },
    siamese: { de: 'Siamkatze', en: 'Siamese', ru: 'Siamese', uk: 'Siamese' },
    'siberian-cat': { de: 'Sibirische Katze', en: 'Siberian Cat', ru: 'Siberian cat', uk: 'Siberian cat' },
    somali: { de: 'Somali', en: 'Somali', ru: 'Somali', uk: 'Somali' },
    sphynx: { de: 'Sphynx', en: 'Sphynx', ru: 'Sphynx', uk: 'Sphynx' },
    'turkish-angora': { de: 'Türkisch Angora', en: 'Turkish Angora', ru: 'Turkish angora', uk: 'Turkish angora' },
  ...
  const serviceDefs = [
    ...
    },
    {
      ...
      note: {
        ...
        ru: 'Итоговая цена зависит от состояния шерсти, колtунов, поведения и времени работы.',
    ...
    },
    {
      key: 'handstrip',
      groups: ['dogs'],
      booking: { de: 'Trimmen / Handstripping', en: 'Hand stripping', ru: 'Тримминг / handstripping', uk: 'Триммінг / handstripping' },
      label: { de: 'Trimmen / Handstripping', en: 'Hand stripping', ru: 'Тримминг / handstripping', uk: 'Триммінг / handstripping' },
      note: {
    ...
    },
    {
      ...
      desc: {
        ...
        ru: 'Стрижка когтей, вычёсывание, удаление колtunов и базовый уход.',
    ...
    },
    {
      key: 'spa',
      groups: ['dogs', 'cats', 'others'],
      booking: { de: 'SPA-Pflege', en: 'SPA care', ru: 'SPA-уход', uk: 'SPA-догляд' },
      label: { de: 'SPA-Pflege', en: 'SPA care', ru: 'SPA-уход', uk: 'SPA-догляд' },
      note: {
