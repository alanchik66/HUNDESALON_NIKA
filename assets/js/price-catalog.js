...
(function initPriceCatalog(global) {
  ...
  const serviceDefs = [
    ...
    },
    {
      ...
      note: {
        de: 'Sanfter Einstieg in die Fellpflege für Welpen bis 4 Monate.',
        en: 'A gentle introduction to grooming for puppies up to 4 months old.',
        ru: 'Бережное знакомство с грумингом для щенков до 4 месяцев.',
        uk: 'Дбайливе знайомство з грумінгом для цуценят до 4 місяців.',
      },
      prices: { default: 'ab 50 €' },
      desc: {
        de: 'Kennenlernen der Pflegeperson, behutsame Gewöhnung an den Pflegetisch, die Bürste und das Föhngeräusch sowie leichte Pflege. Wenn der Welpe ruhig bleibt und die Schritte zulässt, können wir ihn auch vollständig bürsten, baden und sanft antrocknen. Ist er sehr lebhaft oder noch nicht bereit, konzentrieren wir uns auf die Eingewöhnung und gehen in seinem Tempo vor. Entscheidend ist, dass er sich sicher fühlt; nicht alle Pflegeschritte müssen beim ersten Besuch stattfinden.',
        en: 'Meeting the groomer, gently getting used to the grooming table, brush and sound of the dryer, and light care. If the puppy stays calm and allows it, we can also brush the whole coat, give a full bath and gently dry the coat. If the puppy is very lively or not yet ready, we focus on familiarisation and go at their pace. The priority is helping the puppy feel safe, rather than completing every grooming step on the first visit.',
