(function initPriceLocales(global) {
  ...
  const serviceNotesByCategory = {
    'ru-small-growing-coat': [dogServiceNotes.full, dogServiceNotes.bath, otherServiceNotes.puppy],
  ...
  const prices = {
    ...
    from25: { de: 'ab 25 €', en: 'from €25', uk: 'від 25 €' },
  ...
  const common = {
    ...
    spitz: make('ru-spitz', { de: '3. Spitze', en: '3. Spitz breeds', uk: '3. Шпіци' }, breed(['Zwergspitz', 'Deutscher Spitz klein', 'Deutscher Spitz mittel', 'Deutscher Spitz groß'], ['Pomeranian', 'German Spitz, small', 'German Spitz, medium', 'German Spitz, large'], ['Померанський шпіц', 'Німецький шпіц малий', 'Німецький шпіц середній', 'Німецький шпіц великий']), { de: ['Komplettpflege'], en: ['Full grooming'], uk: ['Комплексний грумінг'] }, [p('main90')]),
    ...
    wire: make('ru-wire-coat', { de: '6. Rauhaarige Rassen', en: '6. Wire-coated breeds', uk: '6. Жорсткошерсті породи' }, breed(['West Highland White Terrier', 'Cairn Terrier', 'Jack Russell Terrier', 'Parson Russell Terrier', 'Zwergschnauzer', 'Mittelschnauzer'], ['West Highland White Terrier', 'Cairn Terrier', 'Jack Russell Terrier', 'Parson Russell Terrier', 'Miniature Schnauzer', 'Standard Schnauzer'], ['Вест-хайленд-вайт-тер’єр', 'Керн-тер’єр', 'Джек-рассел-тер’єр', 'Парсон-рассел-тер’єр', 'Цвергшнауцер', 'Міттельшнауцер']), { de: ['Schneiden', 'Baden + Hygienepflege'], en: ['Clipping', 'Bath + hygiene care'], uk: ['Стрижка', 'Купання + гігієнічний догляд'] }, [p('main90'), p('bath70')]),
  ...
  cats: make('ru-cats-grooming', { de: 'Katzen – Ausbürsten / Schneiden', en: 'Cats — brushing / clipping', uk: 'Коти — вичісування / стрижка' }, breed(['Katzen aller Rassen'], ['Cats of all breeds'], ['Коти всіх порід']), { de: ['Ausbürsten / Schneiden + Hygienepflege', 'Ausbürsten / Schneiden + Baden + Hygienepflege'], en: ['Brushing / clipping + hygiene care', 'Brushing / clipping + bath + hygiene care'], uk: ['Вичісування / стрижка + гігієнічний догляд', 'Вичісування / стрижка + купання + гігієнічний догляд'] }, [{ de: 'ab 60 €', en: 'from €60', uk: 'від 60 €' }, { de: 'ab 90 €', en: 'from €90', uk: 'від 90 €' }]),
    ...
    additional: make('ru-additional-services', { de: 'Zusatzleistungen', en: 'Additional services', uk: 'Додаткові послуги' }, breed(['Hunde', 'Katzen', 'Meerschweinchen', 'Kaninchen'], ['Dogs', 'Cats', 'Guinea pigs', 'Rabbits'], ['Собаки', 'Коти', 'Морські свинки', 'Кролики']), { de: ['Krallenschneiden', 'Ultraschall-Zahnpflege bis 6 kg', 'Aufbau- / SPA-Maske', 'Ozontherapie — kleine Rassen', 'Ohrenpflege als Einzelleistung', 'Express-Entwollung / Unterwolle entfernen'], en: ['Nail trimming', 'Ultrasonic teeth cleaning up to 6 kg', 'Restorative / spa mask', 'Ozone therapy — small breeds', 'Ear care as a standalone service', 'Express deshedding / undercoat removal'], uk: ['Підстригання кігтів', 'Ультразвукова чистка зубів до 6 кг', 'Відновлювальна / SPA-маска', 'Озонотерапія — малі породи', 'Догляд за вухами як окрема послуга', 'Експрес-линька / видалення підшерстка'] }, [{ de: '15 €', en: '€15', uk: '15 €' }, p('from100'), p('from20'), p('from25'), { de: '15 €', en: '€15', uk: '15 €' }, { de: '30 € / 30 Min.', en: '€30 / 30 min', uk: '30 € / 30 хв.' }]),
  ...
  const finalLocalizedDogs = {
    'ru-small-growing-coat': {
      title: { de: '1. Langhaarige Rassen', en: '1. Long-haired breeds', uk: '1. Довгошерсті породи' },
      ...
      breeds: {
        de: ['Yorkshire Terrier', 'Biewer Yorkshire Terrier', 'Malteser', 'Shih Tzu', 'Havaneser', 'Bologneser', 'Bolonka Zwetna', 'Lhasa Apso', 'Pekingese', 'Japanischer Chin', 'Chinesischer Schopfhund – Powder Puff'],
        en: ['Yorkshire Terrier', 'Biewer Yorkshire Terrier', 'Maltese', 'Shih Tzu', 'Havanese', 'Bolognese', 'Russian Colored Bolonka', 'Lhasa Apso', 'Pekingese', 'Japanese Chin', 'Chinese Crested — Powder Puff variety'],
        uk: ['Йоркширський тер’єр', 'Бівер-йоркширський тер’єр', 'Мальтезе', 'Ши-тцу', 'Гаванез', 'Болоньєз', 'Російська кольорова болонка', 'Лхаса апсо', 'Пекінес', 'Японський хін', 'Китайська чубата — пухова різновидність'],
      },
    ...
    'ru-poodles-bichons': {
      ...
      breeds: {
        de: ['Toypudel', 'Zwergpudel', 'Kleinpudel', 'Mittelpudel', 'Bichon Frisé', 'Coton de Tuléar', 'Löwchen', 'Maltipoo', 'Yorkipoo', 'Shih-Poo', 'Cavapoo', 'Cockapoo', 'Havapoo', 'Poochon', 'Kleine und mittelgroße Schnoodle'],
        en: ['Toy Poodle', 'Miniature Poodle', 'Small Poodle', 'Medium Poodle', 'Bichon Frise', 'Coton de Tulear', 'Löwchen', 'Maltipoo', 'Yorkipoo', 'Shih-Poo', 'Cavapoo', 'Cockapoo', 'Havapoo', 'Poochon', 'Small and medium Schnoodle'],
        uk: ['Той-пудель', 'Карликовий пудель', 'Малий пудель', 'Середній пудель', 'Бішон-фрізе', 'Котон-де-тулеар', 'Левхен', 'Мальтіпу', 'Йоркіпу', 'Ши-пу', 'Кавапу', 'Кокапу', 'Хавапу', 'Пучон', 'Невеликі та середні шнудлі'],
      },
      labels: { de: ['Komplettpflege', 'Baden + Hygienepflege'], en: ['Full grooming', 'Bath + hygiene care'], uk: ['Комплексний грумінг', 'Купання + гігієнічний догляд'] },
    ...
    'ru-spitz': {
      ...
      section: 'small', additionalServiceGroup: 'mixed',
      breeds: {
        de: ['Pomeranian', 'Deutscher Spitz, Zwergspitz', 'Deutscher Spitz, klein', 'Deutscher Spitz, mittel', 'Deutscher Spitz, groß', 'Wolfsspitz', 'Japan-Spitz', 'Finnischer Spitz'],
        en: ['Pomeranian', 'German Spitz, dwarf', 'German Spitz, small', 'German Spitz, medium', 'German Spitz, large', 'Keeshond', 'Japanese Spitz', 'Finnish Spitz'],
        uk: ['Померанський шпіц', 'Німецький шпіц карликовий', 'Німецький шпіц малий', 'Німецький шпіц середній', 'Німецький шпіц великий', 'Вольфшпіц', 'Японський шпіц', 'Фінський шпіц'],
      },
      labels: { de: ['Komplettpflege', 'Baden + Hygienepflege'], en: ['Full grooming', 'Bath + hygiene care'], uk: ['Комплексний грумінг', 'Купання + гігієнічний догляд'] },
      prices: ['main90', 'request'],
    },
    'ru-spaniels': {
      ...
      breeds: {
        de: ['Englischer Cocker Spaniel', 'Amerikanischer Cocker Spaniel', 'Cavalier King Charles Spaniel', 'King Charles Spaniel', 'Englischer Springer Spaniel', 'Welsh Springer Spaniel', 'Russischer Jagdspaniel', 'Field Spaniel', 'Clumber Spaniel', 'Sussex Spaniel'],
        en: ['English Cocker Spaniel', 'American Cocker Spaniel', 'Cavalier King Charles Spaniel', 'King Charles Spaniel', 'English Springer Spaniel', 'Welsh Springer Spaniel', 'Russian Hunting Spaniel', 'Field Spaniel', 'Clumber Spaniel', 'Sussex Spaniel'],
        uk: ['Англійський кокер-спанієль', 'Американський кокер-спанієль', 'Кавалер-кинг-чарльз-спанієль', 'Кінг-чарльз-спанієль', 'Англійський спрингер-спанієль', 'Вельш-спрингер-спанієль', 'Російський мисливський спанієль', 'Філд-спанієль', 'Кламбер-спанієль', 'Суссекс-спанієль'],
      },
      labels: { de: ['Komplettpflege', 'Baden + Hygienepflege'], en: ['Full grooming', 'Bath + hygiene care'], uk: ['Комплексний грумінг', 'Купання + гігієнічний догляд'] },
    ...
    'ru-short-coat': {
      ...
      section: 'medium', additionalServiceGroup: 'mixed',
      breeds: {
        de: ['Kurzhaar-Chihuahua', 'Glatthaar-Russischer Toy', 'Prager Rattler', 'Toy-Terrier', 'Zwergpinscher', 'Französische Bulldogge', 'Mops', 'Boston Terrier', 'Englische Bulldogge', 'Beagle', 'Kurzhaar-Dackel', 'Kurzhaar-Zwergdackel', 'Italienisches Windspiel', 'Basenji', 'Whippet', 'Deutscher Pinscher', 'Amerikanischer Staffordshire-Terrier', 'Staffordshire Bullterrier', 'Bullterrier', 'Miniatur-Bullterrier', 'Amerikanischer Pitbullterrier', 'Amerikanischer Bully', 'Shar Pei', 'Xoloitzcuintle – mittlere Größe', 'Dobermann', 'Rottweiler', 'Boxer', 'Dalmatiner', 'Weimaraner', 'Rhodesian Ridgeback', 'Cane Corso', 'Amerikanische Bulldogge', 'Dogo Argentino', 'Bullmastiff', 'Deutsche Dogge', 'Deutsch-Kurzhaar', 'Ungarischer Vorstehhund', 'Englischer Pointer', 'Greyhound', 'Podenco Ibicenco', 'Podenco Canario', 'Xoloitzcuintle – Standardgröße'],
        en: ['Short-haired Chihuahua', 'Russian Toy — smooth coat', 'Prague Ratter', 'Toy Terrier', 'Miniature Pinscher', 'French Bulldog', 'Pug', 'Boston Terrier', 'English Bulldog', 'Beagle', 'Short-haired Dachshund', 'Short-haired Miniature Dachshund', 'Italian Greyhound', 'Basenji', 'Whippet', 'German Pinscher', 'American Staffordshire Terrier', 'Staffordshire Bull Terrier', 'Bull Terrier', 'Miniature Bull Terrier', 'American Pit Bull Terrier', 'American Bully', 'Shar Pei', 'Xoloitzcuintli — medium size', 'Dobermann', 'Rottweiler', 'Boxer', 'Dalmatian', 'Weimaraner', 'Rhodesian Ridgeback', 'Cane Corso', 'American Bulldog', 'Dogo Argentino', 'Bullmastiff', 'Great Dane', 'German Shorthaired Pointer', 'Hungarian Vizsla', 'English Pointer', 'Greyhound', 'Ibizan Hound', 'Canarian Hound', 'Xoloitzcuintli — standard size'],
        uk: ['Гладкошерстий чихуахуа', 'Російський той — гладкошерстий', 'Празький крисарик', 'Той-тер’єр', 'Карликовий пінчер', 'Французький бульдог', 'Мопс', 'Бостон-тер’єр', 'Англійський бульдог', 'Бігль', 'Гладкошерста такса', 'Гладкошерста цвергтакса', 'Левретка', 'Басенджі', 'Віппет', 'Німецький пінчер', 'Американський стаффордширський тер’єр', 'Стаффордширський бультер’єр', 'Бультер’єр', 'Мініатюрний бультер’єр', 'Американський пітбультер’єр', 'Американський буллі', 'Шарпей', 'Ксолойтцкуінтлі середнього розміру', 'Доберман', 'Ротвейлер', 'Боксер', 'Далматин', 'Веймаранер', 'Родезійський риджбек', 'Кане-корсо', 'Американський бульдог', 'Аргентинський дог', 'Бульмастиф', 'Німецький дог', 'Курцхаар', 'Угорська вижла', 'Англійський пойнтер', 'Грейхаунд', 'Поденко ібісенко', 'Поденко канаріо', 'Ксолойтцкуінтлі стандартного розміру'],
      },
      labels: {
        de: Array(4).fill('Baden + Hygienepflege'),
        en: Array(4).fill('Bath + hygiene care'),
        uk: Array(4).fill('Купання + гігієнічний догляд'),
      },
    ...
    'ru-large-dogs': {
      ...
      breeds: {
        de: ['Labrador Retriever', 'Golden Retriever', 'Deutscher Schäferhund', 'Belgischer Schäferhund', 'Australischer Schäferhund', 'Border Collie', 'Shetland-Schäferhund', 'Langhaar-Collie', 'Siberian Husky', 'Alaskan Malamute', 'Samojede', 'Chow-Chow', 'Akita Inu', 'Amerikanische Akita', 'Berner Sennenhund', 'Großer Schweizer Sennenhund', 'Neufundländer', 'Leonberger', 'Bernhardiner', 'Bobtail', 'Hovawart', 'Kaukasischer Owtscharka', 'Zentralasiatischer Owtscharka', 'Pyrenäenberghund', 'Komondor', 'Kuvasz', 'Bergamasker Hirtenhund', 'Briard', 'Russischer Schwarzer Terrier', 'Großpudel', 'Große Labradoodle', 'Große Goldendoodle', 'Große Bernedoodle', 'Große Australian Labradoodle'],
        en: ['Labrador Retriever', 'Golden Retriever', 'German Shepherd', 'Belgian Shepherd', 'Australian Shepherd', 'Border Collie', 'Shetland Sheepdog', 'Rough Collie', 'Siberian Husky', 'Alaskan Malamute', 'Samoyed', 'Chow Chow', 'Akita Inu', 'American Akita', 'Bernese Mountain Dog', 'Greater Swiss Mountain Dog', 'Newfoundland', 'Leonberger', 'Saint Bernard', 'Old English Sheepdog', 'Hovawart', 'Caucasian Shepherd', 'Central Asian Shepherd', 'Great Pyrenees', 'Komondor', 'Kuvasz', 'Bergamasco Shepherd', 'Briard', 'Russian Black Terrier', 'Standard Poodle', 'Large Labradoodle', 'Large Goldendoodle', 'Large Bernedoodle', 'Large Australian Labradoodle'],
        uk: ['Лабрадор-ретривер', 'Голден-ретривер', 'Німецька вівчарка', 'Бельгійська вівчарка', 'Австралійська вівчарка', 'Бордер-колі', 'Шелті', 'Довгошерстий колі', 'Сибірський хаскі', 'Аляскинський маламут', 'Самоїд', 'Чау-чау', 'Акіта-іну', 'Американська акіта', 'Бернський зенненхунд', 'Великий швейцарський зенненхунд', 'Ньюфаундленд', 'Леонбергер', 'Сенбернар', 'Бобтейл', 'Ховаварт', 'Кавказька вівчарка', 'Середньоазійська вівчарка', 'Піренейський гірський собака', 'Комондор', 'Кувас', 'Бергамська вівчарка', 'Бріар', 'Російський чорний тер’єр', 'Великий пудель', 'Великі лабрадудлі', 'Великі голдендудлі', 'Великі бернедудлі', 'Великі австралійські лабрадудлі'],
      },
      labels: { de: ['Komplettpflege', 'Baden + Hygienepflege'], en: ['Full care', 'Bath + hygiene care'], uk: ['Комплексний догляд', 'Купання + гігієнічний догляд'] },
      prices: ['main130', 'request'],
    },
  };
