(function initPriceLocales(global) {
  ...
  const common = {
    ...
    additional: make('ru-additional-services', { de: 'Zusatzleistungen', en: 'Additional services', uk: 'Додаткові послуги' }, breed(['Hunde', 'Katzen'], ['Dogs', 'Cats'], ['Собаки', 'Коти']), { de: ['Krallen – kleine Tiere', 'Krallen – mittelgroße Tiere', 'Krallen – große Tiere', 'Ultraschall-Zahnpflege bis 6 kg', 'Aufbau- / Wellnessmaske', 'Ozontherapie'], en: ['Nail trim — small animals', 'Nail trim — medium animals', 'Nail trim — large animals', 'Ultrasonic teeth cleaning up to 6 kg', 'Restorative / wellness mask', 'Ozone therapy'], uk: ['Підрізання кігтів — малі тварини', 'Підрізання кігтів — середні тварини', 'Підрізання кігтів — великі тварини', 'Ультразвукова чистка зубів до 6 кг', 'Відновлювальна / оздоровча маска', 'Озонотерапія'] }, [{ de: '7 €', en: '€7', uk: '7 €' }, { de: '10 €', en: '€10', uk: '10 €' }, { de: '12 €', en: '€12', uk: '12 €' }, p('from100'), p('from15'), p('from20')]),
  ...
  const finalLocalizedDogs = {
    ...
    'ru-short-coat': {
      ...
      breeds: {
        ...
        en: ['Short-haired Chihuahua', 'Russian Toy — smooth coat', 'Prague Ratter', 'Toy Terrier', 'Miniature Pinscher', 'French Bulldog', 'Pug', 'Boston Terrier', 'English Bulldog', 'Beagle', 'Short-haired Dachshund', 'Short-haired Miniature Dachshund', 'Italian Greyhound', 'Basenji', 'Whippet', 'German Pinscher', 'American Staffordshire Terrier / Amstaff', 'Staffordshire Bull Terrier', 'Bull Terrier', 'Miniature Bull Terrier', 'American Pit Bull Terrier', 'American Bully', 'Shar Pei', 'Xoloitzcuintli — medium size', 'Dobermann', 'Rottweiler', 'Boxer', 'Dalmatian', 'Weimaraner', 'Rhodesian Ridgeback', 'Cane Corso', 'American Bulldog', 'Dogo Argentino', 'Bullmastiff', 'Great Dane', 'German Shorthaired Pointer', 'Hungarian Vizsla', 'English Pointer', 'Greyhound', 'Ibizan Hound', 'Canarian Hound / Podenco Canario', 'Xoloitzcuintli — standard size'],
