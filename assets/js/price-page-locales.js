(function initPriceLocales(global) {
  ...
  cats: make('ru-cats-grooming', { de: 'Katzen – Ausbürsten / Schneiden', en: 'Cats — brushing / clipping', uk: 'Коти — вичісування / стрижка' }, breed(['Katzen aller Rassen'], ['Cats of all breeds'], ['Коти всіх порід']), { de: ['Ausbürsten / Schneiden + Hygienepflege', 'Ausbürsten / Schneiden + Baden + Hygienepflege'], en: ['Brushing / clipping + hygiene care', 'Brushing / clipping + bath + hygiene care'], uk: ['Вичісування / стрижка + гігієнічний догляд', 'Вичісування / стрижка + купання + гігієнічний догляд'] }, [{ de: 'ab 60 €', en: 'from €60', uk: 'від 60 €' }, { de: 'ab 90 €', en: 'from €90', uk: 'від 90 €' }]),
    ...
    additional: make('ru-additional-services', { de: 'Zusatzleistungen', en: 'Additional services', uk: 'Додаткові послуги' }, breed(['Hunde', 'Katzen'], ['Dogs', 'Cats'], ['Собаки', 'Коти']), { de: ['Krallenschneiden — kleine Rassen', 'Krallenschneiden — mittelgroße Rassen', 'Krallenschneiden — große Rassen', 'Trimmen', 'Ultraschall-Zahnpflege bis 6 kg', 'Aufbau- / Wellnessmaske', 'Ozontherapie'], en: ['Nail trimming — small breeds', 'Nail trimming — medium breeds', 'Nail trimming — large breeds', 'Trimming', 'Ultrasonic teeth cleaning up to 6 kg', 'Restorative / wellness mask', 'Ozone therapy'], uk: ['Підстригання кігтів — малі породи', 'Підстригання кігтів — середні породи', 'Підстригання кігтів — великі породи', 'Тримінг', 'Ультразвукова чистка зубів до 6 кг', 'Відновлювальна / оздоровча маска', 'Озонотерапія'] }, [{ de: '7 €', en: '€7', uk: '7 €' }, { de: '10 €', en: '€10', uk: '10 €' }, { de: '12 €', en: '€12', uk: '12 €' }, p('request'), p('from100'), p('from15'), p('from20')]),
