# Graph Report - HUNDESALON_NIKA  (2026-09-14)

## Corpus Check
- 422 files · ~524,740 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4029 nodes · 6522 edges · 339 communities (262 shown, 37 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 24 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b94f2e51`
...
- generate-sendpulse-ai-knowledge.mjs
...
- cat-breeds.test.mjs
- price-page-ru-data.test.mjs
- booking-scheduling-smoke.mjs
- Dashboard
- Active Context
...
- reverse-geocode.js
- main.js
- syncHeaderWeatherLiveClock
- google-gateway/package.json
- update-fci-dog-translations.mjs
...
- 9. БИД СТРАТЕГИЯ
- fci-dog-breeds.test.mjs
- apply-google-oauth-token.mjs
...
- refresh-noto-color-emoji-colrv1.mjs
...
- 10. Границы ответов AI-помощника
- ai-chat-attachment-browser-smoke.mjs
...
- Task Queue
- update-animal-breed-photos.mjs
- build-animal-breed-photo-manifest.mjs
- animal-photo-catalog.mjs
- normalizeAnimalPhotoKey
- render-animal-photo-contact-sheets.mjs
- Brand_Assets.md
...
1. `scripts` - 165 edges
2. `🩺 vibe-audit: HUNDESALON_NIKA` - 147 edges
3. `14. Auto-generated public website snapshot ##` - 57 edges
4. `sleep()` - 55 edges
5. `cleanText()` - 54 edges
6. `getEnvValue()` - 51 edges
7. `initAiChat()` - 49 edges
8. `jsonResponse()` - 46 edges
9. `onRequest()` - 36 edges
...
- `onRequest()` --calls--> `hasAiServiceAuth()`  [EXTRACTED]
  functions/lg-task.js → functions/_lib/ai-policy.js

## Import Cycles
- None detected.

## Communities (339 total, 37 thin omitted)

### Community 0 - "scripts"
Cohesion: 0.01
Nodes (165): scripts, animal:photos:build, animal:photos:contact-sheets, animal:photos:update, audit, audit:all, audit:gateway, audit:root (+157 more)
...
### Community 2 - "🐕 HUNDESALON NIKA - Профессиональный груминг-салон #"
Cohesion: 0.05
Nodes (40): Moon assets (header orb), Playback (site-shell), Production output, Source, 1. Подготовка к деплою, 1. Установка расширений VS Code, 2. Деплой в Cloudflare Pages, 2. Запуск локального сервера (+32 more)

### Community 3 - "14. Auto-generated public website snapshot ##"
Cohesion: 0.04
Nodes (57): 14. Auto-generated public website snapshot ##, DE — blog/blog.html ###, DE — blog/kak-podgotovit-sobaku.html ###, DE — blog/plokhaya-strizhka.html ###, DE — blog/preimushchestva-ekspress-linki.html ###, DE — blog/strizhka-koshek.html ###, DE — blog/zashchita-ot-parazitov.html ###, DE — documents.html ### (+49 more)

### Community 4 - "EN — published catalog ###"
Cohesion: 0.13
Nodes (15): 1. Long-haired breeds ####, 2. Poodles, bichons and poodle-type breeds ####, 3. Spitz breeds ####, 4. Spaniels ####, 5. Wire-coated breeds ####, 6. Canonical published price list ##, 6. Short-coated dogs ####, 7. Large dogs #### (+7 more)

### Community 5 - "Google Cloud Shell Setup Guide – HUNDESALON_NIKA"
Cohesion: 0.05
Nodes (37): All-in-One Command, Environment Variables (Already Set in Cloudflare), Google Cloud Shell Setup Guide – HUNDESALON_NIKA, Issue: Authentication fails, Issue: Build fails with "dist/ already exists", Issue: Deployment says "Project not found", Issue: `npm: command not found`, Issue: `wrangler: command not found` (+29 more)

### Community 6 - "Интерактивная галерея "До/После" — Руководство"
Cohesion: 0.05
...
### Community 10 - "Git: один main, GitHub (GitLab mirror removed), Cloudflare"
Cohesion: 0.17
...
### Community 14 - "🩺 vibe-audit: HUNDESALON_NIKA"
Cohesion: 0.01
Nodes (147): 🟡 Auth-роут без rate limit, 🟡 Debug-режим в коде, 🟡 Debug-режим в коде, 🟡 Debug-режим в коде, 🟡 Debug-режим в коде, 🟡 Debug-режим в коде, 🟡 Debug-режим в коде, 🟡 Debug-режим в коде (+139 more)
...
Cohesion: 0.12
Nodes (19): clearLegacyPagesTokenAlias(), saveApiToken(), getWranglerConfigPath(), isDevVarAssignment(), loadDevVars(), persistWranglerOAuth(), removeDevVar(), REPO_ROOT (+11 more)

### Community 18 - "sleep"
Cohesion: 0.06
Nodes (38): port, evalPage(), withCdp(), logoUrls, port, report, siteQ, port (+30 more)
...
Cohesion: 0.07
Nodes (70): breedImageUrl(), AI_CHAT_UPLOAD_CHUNK_MAX_BYTES, AI_CHAT_UPLOAD_MAX_BYTES, completeUpload(), normalizedFile(), normalizedTranscript(), onRequest(), onRequestChunk() (+62 more)

### Community 21 - "HUNDESALON NIKA Full-Stack Upgrade Guide"
Cohesion: 0.14
Nodes (13): Google, Google Apps Script gateway, HUNDESALON NIKA Full-Stack Upgrade Guide, Microsoft OneDrive, Teams и Outlook, Быстрая настройка в Cloudflare, Галерея до/после, Обязательные переменные, Платежи (+5 more)

### Community 22 - "resolveHeaderWeatherLocationMeta"
Cohesion: 0.17
...
Cohesion: 0.21
Nodes (18): applyHeaderWeatherAutoGeoLocation(), emitHeaderWeatherEvent(), getHeaderWeatherDistanceMeters(), getHeaderWeatherHost(), initLanguageDropdown(), isHeaderWeatherTechnicalLocationLabel(), loadHeaderWeatherWidgetLoader(), mountHeaderWeatherWidget() (+10 more)
...
### Community 29 - "Cloudflare API token — HUNDESALON NIKA"
Cohesion: 0.17
...
### Community 30 - "НАСТРОЙКА КАМПАНИИ (Пошагово)"
Cohesion: 0.17
...
### Community 33 - "generate_mcp_yaml.py"
Cohesion: 0.18
Nodes (9): extract_balanced_json(), generate_mcp_yaml(), parse_mcp_servers_md(), process_target_file(), Generates the indented MCP YAML string from a list of server dicts., Reads target file, performs all substitutions, and writes back., Finds the first '{' and extracts the substring until the matching '}'., Parses MCP server definitions from markdown content. Returns a list of server… (+1 more)
...
Cohesion: 0.07
Nodes (44): AI_PROVIDER_POLICY, AI_SERVICE_SECRET_ENV, APPROVED_AI_MODEL, APPROVED_AI_PROVIDER, DEFAULT_DRAFT_MAX_TOKENS, DEFAULT_SEO_MAX_TOKENS, getBearerToken(), getContextEnvVar() (+36 more)

### Community 38 - "SMART Audit Report (2026-05-14)"
Cohesion: 0.18
...
### Community 39 - "HUNDESALON_NIKA Website Knowledge for the SendPulse AI Agent #"
Cohesion: 0.12
Nodes (15): 10. Public educational content ##, 12. Context supplied by the website ##, 12. Правило обновления, 13. SendPulse implementation requirements ##, 15. Verified animal grooming reference ##, 1. Source priority and operating contract ##, 1. Базовые правила для AI-помощника, 2. Public business facts ## (+7 more)

### Community 40 - "booking-confirmation.js"
Cohesion: 0.29
Nodes (9): ALLOWED_HOSTS, BOOKING_CONFIRM_TTL_SECONDS, constantTimeEqual(), encodeBase64Url(), signatureFor(), signingSecret(), env, now (+1 more)

### Community 41 - "Google Ads — ryndenko PMax draft status"
Cohesion: 0.20
...
### Community 42 - "check-email-provider.mjs"
Cohesion: 0.29
Nodes (5): candidates, findings, forbidden, root, roots

### Community 43 - "seo-search-watch.mjs"
Cohesion: 0.11
Nodes (28): analyzeBingFindings(), extractBingSiteScanFindings(), analyzeGscIndexing(), KEY_URLS, readGscIndexing(), GSC_ACCOUNT, GSC_PROPERTY, GSC_SECTIONS (+20 more)

### Community 44 - "5. Core services ##"
Cohesion: 0.17
Nodes (12): 5. Core services ##, Bathing and hygiene care ###, Cat grooming ###, Complete dog grooming ###, Customer media in chat ###, Dental care ###, Express deshedding and coat-change care ###, Handstripping and wire-coat care ### (+4 more)

### Community 45 - "syncHeaderWeatherUnifiedReadings"
Cohesion: 0.13
Nodes (29): applyHeaderWeatherConditionTypography(), applyHeaderWeatherDropdownConditionTypography(), applyHeaderWeatherDropdownReadings(), applyHeaderWeatherPreviewReadings(), buildHeaderWeatherConditionLineTexts(), buildHeaderWeatherReadingsFromMeta(), convertHeaderWeatherHpaToMmHg(), ensureHeaderWeatherPreviewMetricsVisible() (+21 more)

### Community 46 - "5. Собаки"
Cohesion: 0.25
Nodes (8): 5.1. Порода, разновидность, категория и размерный индекс, 5.2. Практические типы шерсти, 5.3. Купание, расчёсывание и сушка, 5.4. Когти и лапы, 5.5. Уши, 5.6. Кожа и глаза, 5.7. Видовые противопоказания для собак, 5. Собаки

### Community 47 - "package.json"
Cohesion: 0.15
Nodes (12): author, description, license, main, name, packageManager, private, repository (+4 more)

### Community 48 - "google-oauth-console-bootstrap.mjs"
Cohesion: 0.21
Nodes (16): CDP_PORT, DOWNLOADS, exchangeCode(), GOOGLE_SCOPES, latestOAuthClientJson(), main(), navigateCdp(), openBrowser() (+8 more)

### Community 49 - "generate-brand-assets.ps1"
Cohesion: 0.40
...
Cohesion: 0.12
Nodes (29): applyHeaderWeatherOrbAtmosphere(), applyHeaderWeatherOrbCrossfade(), applyHeaderWeatherOrbLayout(), applyHeaderWeatherTextReadability(), bindHeaderWeatherLayoutObserver(), clampHeaderWeatherValue(), createHeaderWeatherOrbOverlay(), ensureHeaderWeatherDropdownStarsBackLayer() (+21 more)
...
### Community 53 - "Codex prompt: донастройка Google Ads HUNDESALON_NIKA"
Cohesion: 0.25
...
### Community 54 - "Google Ads Keyword Planner — HUNDESALON NIKA"
Cohesion: 0.25
...
### Community 57 - "Полное руководство по настройке Google Ads для HUNDESALON NIKA"
Cohesion: 0.25
...
### Community 59 - "enforceRateLimit"
Cohesion: 0.21
Nodes (12): ALLOWED_LOCALES, cleanQuery(), normalizedItem(), onRequestGet(), safeGiphyUrl(), enforceRateLimit(), getClientIp(), timingSafeEqualStrings() (+4 more)
...
### Community 61 - "HUNDESALON NIKA — Copilot instructions #"
Cohesion: 0.25
Nodes (7): Before editing ##, Handoff ##, HUNDESALON NIKA — Copilot instructions #, Implementation ##, Project ##, Safety ##, Update command ##
...
### Community 63 - "lengthen-meta-descriptions.mjs"
Cohesion: 0.33
Nodes (5): escapeAttr(), langs, report, root, setMetaContent()

### Community 64 - "server.js"
Cohesion: 0.21
Nodes (19): appendSheetRow(), createCalendarEvent(), createSetup(), firestoreValue(), getCalendarBusyIntervals(), getGoogleToken(), getSecret(), googleJson() (+11 more)
...
### Community 66 - "bing-webmaster-complete.mjs"
Cohesion: 0.18
...
### Community 68 - "Cloudflare caching for hundesalon-nika.com"
Cohesion: 0.29
...
### Community 69 - "Code of Conduct"
Cohesion: 0.29
Nodes (6): Code of Conduct, Enforcement, Expected Behavior, Our Commitment, Reporting, Unacceptable Behavior

### Community 70 - "site-shell.js"
Cohesion: 0.11
Nodes (34): applyHeaderWeatherEqualMetricSpacing(), bindHeaderWeatherScrollContainment(), buildLanguageUrl(), createHeaderMarkup(), extractSupportedLang(), fetchHeaderWeatherSourceTimeMs(), fitHomeLabelToLogo(), getHeaderWeatherScrollableDropdownContainer() (+26 more)
...
### Community 72 - "ISSUE_TEMPLATE.md"
Cohesion: 0.29
...
### Community 74 - "11. Response patterns ##"
Cohesion: 0.29
Nodes (7): 11. Response patterns ##, Availability or opening-date question ###, Booking question ###, First appointment ###, Human handoff ###, Medical or emergency question ###, Price question ###

### Community 75 - "bindHeaderWeatherState"
Cohesion: 0.20
Nodes (19): applyHeaderWeatherLocationSearchCopy(), applyHeaderWeatherTransparency(), bindHeaderWeatherDropdownScrollState(), bindHeaderWeatherOutsideDismiss(), bindHeaderWeatherReadingsObserver(), bindHeaderWeatherState(), enforceHeaderWeatherToggleArrow(), enhanceHeaderWeatherCloudRenderer() (+11 more)
...
### Community 77 - "booking-calendar.js"
Cohesion: 0.17
...
### Community 78 - "rewrite-meta-clean.mjs"
Cohesion: 0.40
...
Cohesion: 0.13
Nodes (29): candidates, main(), auditToken(), GROUP_IDS, isDeployToken(), isFullToken, isFullZoneToken(), isUnifiedToken() (+21 more)

### Community 81 - "overrides"
Cohesion: 0.25
Nodes (8): overrides, esbuild, fast-uri, js-yaml, sharp, smol-toml, undici, ws

### Community 82 - "Contributing #"
Cohesion: 0.33
Nodes (5): Before You Start, Commit Messages, Contributing, Development Checklist, Pull Requests

### Community 83 - "GBP HUNDESALON_NIKA — ryndenko1982"
Cohesion: 0.33
...
Cohesion: 0.33
Nodes (6): Active work, HUNDESALON_NIKA, Objective, Open links, Project facts, Working rules

### Community 86 - "2026-08-28 - Separate Roo Code and VS Code Flow Layers"
Cohesion: 0.33
Nodes (5): 2026-08-28 - Separate Roo Code and VS Code Flow Layers, Constraints, Decision, Decision Log, Rationale
...
Cohesion: 0.33
Nodes (5): Architecture, Product, Product Context, Quality Goals, Supported Locales
...
### Community 91 - "System Patterns"
Cohesion: 0.33
Nodes (5): Cloudflare, Frontend, Localization, System Patterns, Tooling

### Community 92 - "price-list-smoke.mjs"
Cohesion: 0.07
Nodes (24): failures, reports, routes, layouts, locales, MIME_TYPES, resolveRequestPath(), startStaticTestServer() (+16 more)
...
### Community 97 - "manage-sendpulse-sender.mjs"
Cohesion: 0.67
Nodes (5): getAccessToken(), getArg(), listSenders(), main(), sendPulseRequest()

### Community 98 - "SendPulse: архитектура HUNDESALON NIKA"
Cohesion: 0.12
Nodes (15): Automation 360 и CRM, DNS и доставляемость, Events Manager, Live chat routing and AI, Mailing list и переменные, Production checklist, SendPulse: архитектура HUNDESALON NIKA, Telegram-уведомления сайта (+7 more)

### Community 99 - "booking-submit.test.mjs"
Cohesion: 0.15
...
Cohesion: 0.40
Nodes (5): 8. First-visit preparation and salon rules ##, DE — de/agb.html ###, EN — en/agb.html ###, RU — ru/agb.html ###, UK — uk/agb.html ###

### Community 102 - "update-fci-dog-breeds.mjs"
Cohesion: 0.12
Nodes (36): addClassificationEntries(), applyTranslations(), assertSameNumberSet(), assertUniqueNumbers(), buildOfficialRegistry(), decodeHtmlEntities(), extractAnchors(), extractElementTextById() (+28 more)

### Community 103 - "Google Ads — account negative keywords (HUNDESALON NIKA)"
Cohesion: 0.40
Nodes (4): Active list, Google Ads — account negative keywords (HUNDESALON NIKA), Intentionally not excluded, Purpose

### Community 104 - "Bing Webmaster Tools — полный чеклист"
Cohesion: 0.33
Nodes (5): Bing Webmaster Tools — полный чеклист, URL Submission API, Вне Bing (но обязательно), Отчёт автопрохода, Статус (2026-09-01)

### Community 105 - "2. Дополнительные конверсии (клик по телефону)"
Cohesion: 0.40
...
### Community 106 - "Шаг 6: Расширения объявлений"
Cohesion: 0.40
...
### Community 107 - "Шаг 2: Общие настройки"
Cohesion: 0.40
Nodes (5): Аудитории:, Местоположение:, Сеть:, Шаг 2: Общие настройки, Языки:

### Community 108 - "ПРОБЛЕМЫ И РЕШЕНИЯ"
Cohesion: 0.40
Nodes (5): Высокий CPC:, Нет конверсий:, Нет показов:, Низкий CTR:, ПРОБЛЕМЫ И РЕШЕНИЯ

### Community 109 - "sendmail.js"
Cohesion: 0.08
Nodes (37): buildBookingConfirmationUrl(), addLocalMinutes(), ADMIN_EMAIL_COPY, BOOKING_BEHAVIOUR_EXTRA_MINUTES, BOOKING_BEHAVIOURS, BOOKING_CLIENT_TYPES, BOOKING_COAT_CONDITIONS, BOOKING_COAT_EXTRA_MINUTES (+29 more)

### Community 110 - "3. КЛЮЧЕВЫЕ СЛОВА"
Cohesion: 0.40
...
### Community 112 - "5. РАСШИРЕНИЯ ОБЪЯВЛЕНИЙ"
Cohesion: 0.40
...
### Community 113 - "6. ПОСАДОЧНЫЕ СТРАНИЦЫ"
Cohesion: 0.40
Nodes (5): 6. ПОСАДОЧНЫЕ СТРАНИЦЫ, Для английских запросов:, Для немецких запросов:, Для русских запросов:, Основная:

### Community 114 - "cat-breeds.test.mjs"
Cohesion: 0.22
Nodes (6): baseSources, catSources, expectedCatCategoryIds, expectedSmallAnimalCategoryIds, locales, root

### Community 115 - "price-page-ru-data.test.mjs"
Cohesion: 0.18
Nodes (9): bathLabels, dogIds, expectedCategoryIds, nailTrimLabels, puppyCarePatterns, puppyLabels, puppyPrices, root (+1 more)

### Community 116 - "booking-scheduling-smoke.mjs"
Cohesion: 0.29
Nodes (4): checks, localeCopy, locales, outDir

### Community 117 - "Dashboard"
Cohesion: 0.50
Nodes (4): Dashboard, Open work, Quick launcher, Recent changes

### Community 118 - "Active Context"
Cohesion: 0.40
Nodes (4): Active Context, Current Focus, Current State, Open Questions

### Community 119 - "HUNDESALON_NIKA Makler Legal Snapshot"
Cohesion: 0.15
Nodes (12): Commercial-rental checklist for fast but safe decisions, Downloadable reference material, EU: privacy and AI layer, Further literature noted by IHK Leipzig, Germany: broker regulation, Germany: commercial lease baseline, Germany: outreach and direct marketing limits, HUNDESALON_NIKA Makler Legal Snapshot (+4 more)

### Community 120 - "build-production.js"
Cohesion: 0.09
Nodes (24): assertLocalAssetVersions(), walk(), assertNoSecretArtifacts(), walk(), assetVersion, copyEntries, deferNonCriticalScripts(), walk() (+16 more)
...
### Community 122 - "Progress"
Cohesion: 0.40
Nodes (4): Completed, Current, Next, Progress

### Community 123 - "weather.js"
Cohesion: 0.13
...
### Community 127 - "syncHeaderWeatherLiveClock"
Cohesion: 0.36
Nodes (8): buildHeaderWeatherMetaText(), formatHeaderWeatherLiveTime(), formatHeaderWeatherLiveWeekday(), getHeaderWeatherKnownWeekdayTokens(), resolveHeaderWeatherDateLocale(), rewriteHeaderWeatherTimeText(), stripHeaderWeatherWeekdayTokens(), syncHeaderWeatherLiveClock()

### Community 128 - "google-gateway/package.json"
Cohesion: 0.17
Nodes (11): busboy, dependencies, busboy, engines, node, name, private, scripts (+3 more)

### Community 129 - "update-fci-dog-translations.mjs"
Cohesion: 0.20
Nodes (17): addTranslation(), decodeEntities(), fetchText(), htmlToText(), loadRegistry(), loadRussianNames(), loadUkrainianNames(), main() (+9 more)

### Community 130 - "DE — published catalog ###"
Cohesion: 0.14
Nodes (14): 1. Langhaarige Rassen ####, 2. Pudel, Bichons und Pudeltypen ####, 3. Spitze ####, 4. Spaniels ####, 5. Rauhaarige Rassen ####, 6. Kurzhaarige Hunde ####, 7. Große Hunde ####, DE — published catalog ### (+6 more)
...
### Community 133 - "RU — published catalog ###"
Cohesion: 0.14
Nodes (14): 1. Длинношёрстные породы ####, 2. Пудели, бишоны и пудельные породы ####, 3. Шпицы ####, 4. Спаниели ####, 5. Жёсткошёрстные породы ####, 6. Короткошёрстные собаки ####, 7. Крупные собаки ####, RU — published catalog ### (+6 more)

### Community 134 - "release.ps1"
Cohesion: 0.60
Nodes (3): Invoke-NpmScript(), Write-Ok(), Write-Step()

### Community 135 - "platform-integrations.js"
Cohesion: 0.11
Nodes (47): isWithinBookingHorizon(), normalizeBusyIntervals(), normalizeDate(), onRequestGet(), readFormDataBody(), answerTelegramCallbackQuery(), appendGoogleSheetRow(), base64Encode() (+39 more)

### Community 136 - "booking-pet-profile-smoke.mjs"
Cohesion: 0.40
Nodes (3): expected, locales, results

### Community 137 - "Шаг 4: Группы объявлений"
Cohesion: 0.50
Nodes (4): Группа 1: Основные услуги, Группа 2: Конкретные услуги, Группа 3: По породам (опционально), Шаг 4: Группы объявлений

### Community 138 - "НЕДЕЛЬНАЯ ОПТИМИЗАЦИЯ"
Cohesion: 0.50
Nodes (4): Каждую пятницу:, Каждую среду:, Каждый понедельник:, НЕДЕЛЬНАЯ ОПТИМИЗАЦИЯ

### Community 139 - "СЛЕДУЮЩИЕ ШАГИ"
Cohesion: 0.50
...
### Community 141 - "contact-map.js"
Cohesion: 0.35
Nodes (11): addMapModeControls(), getGoogleMapsKey(), getMapLanguage(), getModeLabels(), initGoogleMap(), showRoadMap(), initMaps(), loadGoogleMaps() (+3 more)
...
### Community 149 - "РЕКОМЕНДАЦИИ ПО OПТИМИЗАЦИИ"
Cohesion: 0.50
...
### Community 154 - "UK — published catalog ###"
Cohesion: 0.14
Nodes (14): 1. Довгошерсті породи ####, 2. Пуделі, бішони та пудельні породи ####, 3. Шпіци ####, 4. Спанієлі ####, 5. Жорсткошерсті породи ####, 6. Короткошерсті собаки ####, 7. Великі собаки ####, UK — published catalog ### (+6 more)

### Community 155 - "4. Универсальный протокол обращения и стресса"
Cohesion: 0.50
Nodes (4): 4.1. Рабочая среда, 4.2. Чтение поведения, 4.3. Обязательное прекращение, 4. Универсальный протокол обращения и стресса

### Community 156 - "email-template.js"
Cohesion: 0.18
Nodes (14): COPY, isValidEmail(), json(), onRequestPost(), bodyToHtml(), buildBrandedEmail(), escapeHtml(), FOOTER_COPY (+6 more)
...
### Community 161 - "14. ПОДДЕРЖКА И ТРАБЛШУТИНГ"
Cohesion: 0.50
...
### Community 165 - "2. СТРУКТУРА КАМПАНИИ"
Cohesion: 0.50
...
### Community 173 - "fci-dog-breeds.test.mjs"
Cohesion: 0.17
Nodes (8): BASE_SOURCES, DOG_CATEGORY_IDS, EXPECTED_CATEGORY_COUNTS, EXPECTED_COAT_CATEGORY_COUNTS, EXPECTED_IRISH_WOLFHOUND, FCI_SOURCES, LOCALES, ROOT

### Community 174 - "apply-google-oauth-token.mjs"
Cohesion: 0.20
Nodes (8): clientDocument, clientPath, devVarsPath, root, secrets, token, tokenPath, wranglerPath

### Community 175 - "info-auto-reply/src/index.js"
Cohesion: 0.23
Nodes (9): suppressedMessages, decodeHeader(), decodeQuotedPrintable(), detectLanguage(), email(), fetchWithTimeout(), getForwardDestinations(), sendAutoReply() (+1 more)

### Community 176 - "setHeaderWeatherOrbSource"
Cohesion: 0.27
Nodes (12): clearHeaderWeatherOrbCanvas(), drawHeaderWeatherOrbFrame(), mountHeaderWeatherSunScene(), resolveHeaderWeatherOrbCropBox(), setHeaderWeatherOrbSource(), startHeaderWeatherOrbRender(), startHeaderWeatherOrbTimelineSync(), stopHeaderWeatherMoonTimelineSync() (+4 more)

### Community 177 - "Bug Report - {{date}}"
Cohesion: 0.22
...
### Community 188 - "HUNDESALON_NIKA Makler"
Cohesion: 0.29
...
### Community 206 - "complete-manual-checklist.mjs"
Cohesion: 0.13
Nodes (15): bingPort, ensureBingCdp(), main(), report, root, runBingClarity(), runBingSiteScan(), runCsamSetup() (+7 more)

### Community 210 - "10. Границы ответов AI-помощника"
Cohesion: 0.25
Nodes (8): 10.1. Что бот может делать, 10.2. Что бот не может делать, 10.3. Правило языка клиента, 10.4. Шаблон безопасного ответа, 10.5. Частичная гигиеническая услуга вместо автоматического пакета, 10.6. Свой шампунь клиента, 10.7. Фото, видео, аудио и документы в чате, 10. Границы ответов AI-помощника

### Community 211 - "11. Источники и область их применения"
Cohesion: 0.40
Nodes (5): 11.1. Породы собак и разновидности шерсти, 11.2. Собаки и кошки, 11.3. Морские свинки, 11.4. Кролики, 11. Источники и область их применения

### Community 212 - "6. Кошки"
Cohesion: 0.40
Nodes (5): 6.1. Шерсть и безопасный уход, 6.2. Обращение и стресс, 6.3. Когти, уши, кожа и глаза, 6.4. Видовые противопоказания для кошек, 6. Кошки

### Community 213 - "7. Морские свинки"
Cohesion: 0.40
Nodes (5): 7.1. Шерсть и уход, 7.2. Обращение и стресс, 7.3. Когти, уши, кожа, глаза и задняя зона, 7.4. Красные флаги и противопоказания для морских свинок, 7. Морские свинки

### Community 214 - "8. Кролики"
Cohesion: 0.40
...
Cohesion: 0.18
Nodes (9): clockPath, iconDirectory, iconFiles, iconNames, ignoredDirectories, ignoredFiles, missingReferences, root (+1 more)

### Community 218 - "ai-chat-upload-live-smoke.mjs"
Cohesion: 0.25
Nodes (6): baseUrl, completionPayload, content, contentSha256, endpoint, timestamp
...
### Community 231 - "Проверенный отчёт vibe-audit — HUNDESALON_NIKA"
Cohesion: 0.17
Nodes (11): 1. Stripe webhook читает тело запроса без собственного лимита, 2. Уязвимость DoS в dev-зависимости Markdown-линтера, Внешние кабинеты и восстановление, Границы проверки, Заголовок `Server: cloudflare`, Информационное замечание, Исправленные важные проблемы, Итог (+3 more)

### Community 232 - "run-npm-quiet.mjs"
Cohesion: 0.40
Nodes (3): args, env, npmCmd

### Community 233 - "generate-ai-chat-emoji-data.mjs"
Cohesion: 0.40
Nodes (4): groups, OUTPUT, payload, ROOT

### Community 235 - "weather-widget-smoke.mjs"
Cohesion: 0.40
Nodes (4): consoleErrors, failedRequests, host, sunScene404

### Community 237 - "deploy-pages.mjs"
Cohesion: 0.21
Nodes (13): deployPages(), ensureDeployCredentials(), localWrangler, pagesDeployEnv(), root, runWrangler(), runWranglerQuiet(), wranglerCommand() (+5 more)
...
### Community 240 - "sync-noto-color-emoji.mjs"
Cohesion: 0.40
Nodes (4): root, targetCssPath, targetFontDirectory, woff2Files
...
### Community 254 - "10. Границы ответов AI-помощника"
Cohesion: 0.25
Nodes (8): 10.1. Что бот может делать, 10.2. Что бот не может делать, 10.3. Правило языка клиента, 10.4. Шаблон безопасного ответа, 10.5. Частичная гигиеническая услуга вместо автоматического пакета, 10.6. Свой шампунь клиента, 10.7. Фото, видео, аудио и документы в чате, 10. Границы ответов AI-помощника

### Community 255 - "ai-chat-attachment-browser-smoke.mjs"
Cohesion: 0.25
Nodes (5): baseUrl, completedCopy, failedCopy, locales, viewports

### Community 256 - "HUNDESALON_NIKA: предметный справочник по безопасному грумингу животных"
Cohesion: 0.33
Nodes (5): 12. Правило обновления, 1. Базовые правила для AI-помощника, 2. Иерархия решений, 3. Минимальный предгруминговый сбор сведений, HUNDESALON_NIKA: предметный справочник по безопасному грумингу животных

### Community 257 - "11. Источники и область их применения"
Cohesion: 0.40
Nodes (5): 11.1. Породы собак и разновидности шерсти, 11.2. Собаки и кошки, 11.3. Морские свинки, 11.4. Кролики, 11. Источники и область их применения

### Community 258 - "6. Кошки"
Cohesion: 0.40
Nodes (5): 6.1. Шерсть и безопасный уход, 6.2. Обращение и стресс, 6.3. Когти, уши, кожа и глаза, 6.4. Видовые противопоказания для кошек, 6. Кошки

### Community 259 - "7. Морские свинки"
Cohesion: 0.40
Nodes (5): 7.1. Шерсть и уход, 7.2. Обращение и стресс, 7.3. Когти, уши, кожа, глаза и задняя зона, 7.4. Красные флаги и противопоказания для морских свинок, 7. Морские свинки

### Community 260 - "8. Кролики"
Cohesion: 0.40
Nodes (5): 8.1. Шерсть и уход, 8.2. Обращение и защита позвоночника, 8.3. Когти, уши, кожа, глаза и задняя зона, 8.4. Красные флаги и противопоказания для кроликов, 8. Кролики
...
### Community 263 - "9. Единая матрица красных флагов"
Cohesion: 0.50
Nodes (4): 9.1. Немедленно прекратить процедуру и рекомендовать экстренную ветеринарную помощь, 9.2. Не начинать или остановить и рекомендовать скорую ветеринарную консультацию, 9.3. Остановить по поведенческой безопасности, 9. Единая матрица красных флагов

### Community 268 - "sync-brand-profiles.mjs"
Cohesion: 0.22
Nodes (7): SAME_AS, businessDesc, indexFiles, pickSameAsHost(), report, root, updateLlmsTxt()

### Community 269 - "configure-cloudflare-cache-features.mjs"
Cohesion: 0.23
Nodes (16): enableContentScan(), getContentScanStatus(), getCrawlerHintsStatus(), main(), parseArgs(), resolveAuth(), setCrawlerHints(), resolveAuth() (+8 more)

### Community 271 - "http-security.js"
Cohesion: 0.12
Nodes (31): applyApiResponseHeaders(), applyCorsResponseHeaders(), assertAllowedOrigin(), bodyTooLargeError(), getOriginHost(), getPublicReadCorsOrigin(), isAllowedOrigin(), isLocalDevOrigin() (+23 more)
...
### Community 280 - "open-citation-registrations.mjs"
Cohesion: 0.22
Nodes (8): CITATION_NAP, LOCAL_DIRECTORIES, q, q2, candidates, pidFile, urls, userDataDir

### Community 281 - "expand-thin-pages.mjs"
Cohesion: 0.29
Nodes (5): block(), COPY, jobs, root, upsert()

### Community 282 - "bing-robots-tester.mjs"
Cohesion: 0.29
Nodes (6): out, port, report, root, siteQ, testLabel

### Community 283 - "local-citations-automate.mjs"
Cohesion: 0.29
Nodes (5): out, port, probeUrl(), report, root

### Community 284 - "env.js"
Cohesion: 0.33
Nodes (5): GA_MEASUREMENT_ID, GOOGLE_ADS_CONVERSION_SEND_TO, GOOGLE_ADS_ID, MS_CLARITY_ID, PUBLIC_ENV

### Community 295 - "Task - ${title}"
Cohesion: 0.11
Nodes (18): Acceptance criteria, Consequences, Constraints, Context, Context, Decision, Decision - ${title}, Follow-up (+10 more)

### Community 296 - "Task - Verify Codex Obsidian workflow"
Cohesion: 0.17
Nodes (12): Acceptance criteria, Constraints, Context, Notes, Objective, Plan, Residual risks, Result (+4 more)

### Community 298 - "discover-google-maps.mjs"
Cohesion: 0.33
Nodes (5): out, port, queries, results, root

### Community 299 - "set-bing-api-key.mjs"
Cohesion: 0.33
...
### Community 341 - "Code Map"
Cohesion: 0.40
Nodes (5): Code Map, Editing rules, Frontend data, Styling, Workers

### Community 360 - "Model Routing and Obsidian Workflow"
Cohesion: 0.33
Nodes (6): Consequences, Context, Decision, Follow-up, Model Routing and Obsidian Workflow, Options

### Community 388 - "Index.md"
Cohesion: 0.14
Nodes (6): Inbox, Projects, Areas, Decision Log, Decision note format, {{title}}

### Community 390 - "Task Queue"
Cohesion: 0.40
Nodes (5): Decision log, Open tasks, Routing source, Task Queue, Workflow

### Community 564 - "update-animal-breed-photos.mjs"
Cohesion: 0.14
Nodes (29): chunks(), decodeHtml(), fetchJson(), fileTitleFromUrl(), followTitle(), genericBreedTokens, isSupportedFreeLicense(), manualExactness (+21 more)

### Community 607 - "build-animal-breed-photo-manifest.mjs"
Cohesion: 0.08
Nodes (27): assetJobs, assetsDirectory, candidatesByKey, candidatesPath, catalogByKey, downloadAndOptimize(), entriesByKey, expectedFilenames (+19 more)

### Community 929 - "animal-photo-catalog.mjs"
Cohesion: 0.16
Nodes (10): expectedSmallAnimalSources, manifestPath, root, byKind, duplicatePhotoTitles, { records, uniqueRecords }, report, catalogSources (+2 more)

### Community 1133 - "normalizeAnimalPhotoKey"
Cohesion: 0.21
Nodes (12): cleanSlug(), generatedLookupKey(), normalizeAnimalPhotoKey(), candidates, entries, isBreedPage(), meaningfulTokens(), preparedRecords (+4 more)

### Community 1166 - "render-animal-photo-contact-sheets.mjs"
Cohesion: 0.25
Nodes (6): context, entries, manifestPath, outputDirectory, pages, projectRoot

### Community 1283 - "Brand_Assets.md"
Cohesion: 0.29
Nodes (5): Approved public identity, Asset rules, Brand Assets, Suggested asset log, Resources

### Community 1284 - "2026-08-30 — Monthly code and artifact cleanup"
Cohesion: 0.12
Nodes (16): 2026-08-30 — Monthly code and artifact cleanup, Authorized form-safety release preparation — 2026-08-30, Authorized release preparation — 2026-08-30, Evidence format, Initial Cloudflare follow-up — verified live on 2026-08-30, Minimum checks, Pass criteria, Photo-upload verification follow-up — 2026-08-30 (+8 more)

### Community 1285 - "Release"
Cohesion: 0.50
Nodes (4): Preflight, Release, Release steps, Rollback note

### Community 1286 - "Daily Note - 2026-08-24"
Cohesion: 0.50
Nodes (4): Daily Note - 2026-08-24, Done, Focus, Next

### Community 1378 - "Codex Control Center"
Cohesion: 0.29
Nodes (7): Codex Control Center, Current workflow, Model defaults, Purpose, Safety checks, Start here, Status

### Community 1423 - "Codex Model Routing"
Cohesion: 0.40
Nodes (5): Codex Model Routing, Obsidian workflow, Operating rule, Purpose, Routing rules

## Knowledge Gaps
- **1941 isolated node(s):** `🌟 Особенности`, `📁 Структура проекта`, `1. Установка расширений VS Code`, `2. Запуск локального сервера`, `3. Проверка кода` (+1936 more)
...
- **Why does `sleep()` connect `sleep` to `bing-webmaster-complete.mjs`, `bing-webmaster-automate.mjs`, `cf-pages-token.mjs`, `discover-google-maps.mjs`, `bing-wmt.mjs`, `seo-search-watch.mjs`, `complete-manual-checklist.mjs`, `google-oauth-console-bootstrap.mjs`, `stopTrackedBrowser`, `bing-sitescan.mjs`, `bing-sitescan-results.mjs`, `local-citations-automate.mjs`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `page()` connect `booking-confirm.js` to `rewrite-meta-clean.mjs`, `extend-meta-descriptions-config.mjs`, `meta-descriptions.mjs`, `fit-meta-descriptions.mjs`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `loadDevVars()` connect `cloudflare-auth.mjs` to `manage-sendpulse-sender.mjs`, `generate-sendpulse-ai-knowledge.mjs`, `cf-pages-token.mjs`, `configure-cloudflare-cache-features.mjs`, `cf-api-token.mjs`, `cloudflareApi`, `bing-fetch-api-key.mjs`, `configure-cloudflare-waf-rate-limits.mjs`?**
