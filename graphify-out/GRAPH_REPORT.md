# Graph Report - HUNDESALON_NIKA  (2026-09-05)

## Corpus Check
- 376 files · ~463,759 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3556 nodes · 5531 edges · 313 communities (243 shown, 33 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 19 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `34624682`
...
- 5. Core services ##
- refreshHeaderWeatherPreviewValues
...
3. `sleep()` - 55 edges
4. `getEnvValue()` - 43 edges
5. `syncHeaderWeatherOrbOverlay()` - 35 edges
6. `jsonResponse()` - 34 edges
7. `enforceHeaderWeatherMenuPlacement()` - 32 edges
8. `onRequest()` - 31 edges
9. `rules` - 29 edges
10. `HUNDESALON_NIKA Website Knowledge for the SendPulse AI Agent #` - 28 edges
...
## Communities (313 total, 33 thin omitted)

### Community 0 - "scripts"
Cohesion: 0.01
Nodes (162): scripts, animal:photos:build, animal:photos:contact-sheets, animal:photos:update, audit, audit:all, audit:gateway, audit:root (+154 more)
...
Cohesion: 0.15
Nodes (13): 1. Long-haired breeds ####, 2. Poodles, bichons and poodle-type breeds ####, 3. Spitz breeds ####, 4. Spaniels ####, 5. Wire-coated breeds ####, 6. Short-coated dogs ####, 7. Large dogs ####, Additional services #### (+5 more)
...
Cohesion: 0.12
Nodes (24): alignHeaderWeatherFeelsLikeRow(), applyHeaderWeatherFeelsLikePreview(), applyHeaderWeatherFeelsReferencePresetLayout(), buildHeaderWeatherCelsiusUnitMarkup(), enforceHeaderWeatherMenuPlacement(), ensureHeaderWeatherInfoPanel(), ensureHeaderWeatherMenuPlacementLock(), ensureHeaderWeatherMenuToggleAnchor() (+16 more)
...
### Community 11 - "sleep"
Cohesion: 0.06
Nodes (40): port, port, out, port, report, root, siteQ, testLabel (+32 more)

### Community 12 - "api/ai-chat.js"
Cohesion: 0.11
Nodes (29): buildConversationInput(), buildSafetyIdentifier(), callOpenAi(), CONCEPT_GROUPS, ensureRussianPriceDisclosure(), extractResponseText(), FALLBACK_COPY, getEditDistance() (+21 more)

### Community 13 - "initAiChat"
Cohesion: 0.17
Nodes (22): appendSafeAnswer(), button(), icon(), initAiChat(), addMessage(), autoGrow(), clickNativeChat(), closePopovers() (+14 more)

### Community 14 - "local-citations-automate.mjs"
Cohesion: 0.13
Nodes (13): CITATION_NAP, LOCAL_DIRECTORIES, q, q2, out, port, probeUrl(), report (+5 more)

### Community 15 - "rules"
Cohesion: 0.06
Nodes (48): env, browser, es2021, node, extends, globals, console, document (+40 more)

### Community 16 - "platform-integrations.js"
Cohesion: 0.20
Nodes (27): appendGoogleSheetRow(), base64Encode(), base64UrlEncode(), callGoogleAppsScriptGateway(), cleanTelegramText(), createGoogleCalendarEvent(), fetchWithTimeout(), FORM_HEADERS (+19 more)

### Community 17 - "cloudflare-auth.mjs"
Cohesion: 0.14
Nodes (16): clearLegacyPagesTokenAlias(), getWranglerConfigPath(), isDevVarAssignment(), loadDevVars(), persistWranglerOAuth(), removeDevVar(), resolvePurgeAuth(), useWranglerFixture() (+8 more)

### Community 18 - "withCdpSession"
Cohesion: 0.09
...
### Community 20 - "reverse-geocode.js"
Cohesion: 0.25
...
Cohesion: 0.17
Nodes (16): buildHeaderWeatherDistrictLabel(), fetchHeaderWeatherAstroDay(), fetchHeaderWeatherReverseGeoMeta(), getHeaderWeatherBrowserTimeZone(), getHeaderWeatherDateInTimeZone(), getHeaderWeatherLanguageFallbacks(), getHeaderWeatherLocationLabel(), isHeaderWeatherTechnicalLocationLabel() (+8 more)
...
### Community 24 - "brand-profiles.mjs"
Cohesion: 0.20
Nodes (8): BRAND_PROFILES, NAP, COPY, root, COPY, root, port, root

### Community 25 - "getEnvValue"
Cohesion: 0.26
Nodes (14): getEnvValue(), depositCents(), onRequest(), paymentsOnlineEnabled(), siteOrigin(), stripeForm(), stripeGet(), stripeKey() (+6 more)
...
Cohesion: 0.15
Nodes (22): applyHeaderWeatherAutoGeoLocation(), applyHeaderWeatherLocationSearchCopy(), emitHeaderWeatherEvent(), formatHeaderWeatherCityDistrictDisplayLabel(), getHeaderWeatherDistanceMeters(), getHeaderWeatherHost(), getHeaderWeatherLocationStatusCopy(), initLanguageDropdown() (+14 more)
...
Cohesion: 0.10
Nodes (32): AI_PROVIDER_POLICY, AI_SERVICE_SECRET_ENV, APPROVED_AI_MODEL, APPROVED_AI_PROVIDER, constantTimeEqual(), DEFAULT_DRAFT_MAX_TOKENS, DEFAULT_SEO_MAX_TOKENS, getBearerToken() (+24 more)
...
### Community 40 - "configure-cloudflare-cache-features.mjs"
Cohesion: 0.31
Nodes (12): enableContentScan(), getContentScanStatus(), getCrawlerHintsStatus(), main(), parseArgs(), resolveAuth(), setCrawlerHints(), resolveAuth() (+4 more)
...
Cohesion: 0.20
Nodes (10): 5. Core services ##, Bathing and hygiene care ###, Cat grooming ###, Complete dog grooming ###, Dental care ###, Express deshedding and coat-change care ###, Handstripping and wire-coat care ###, Puppy introduction ### (+2 more)

### Community 45 - "refreshHeaderWeatherPreviewValues"
Cohesion: 0.12
...
### Community 46 - "HUNDESALON_NIKA: предметный справочник по безопасному грумингу животных"
Cohesion: 0.04
Nodes (46): 10.1. Что бот может делать, 10.2. Что бот не может делать, 10.3. Правило языка клиента, 10.4. Шаблон безопасного ответа, 10. Границы ответов AI-помощника, 11.1. Породы собак и разновидности шерсти, 11.2. Собаки и кошки, 11.3. Морские свинки (+38 more)
...
### Community 59 - "sync-brand-profiles.mjs"
Cohesion: 0.22
...
Cohesion: 0.19
Nodes (21): appendSheetRow(), createCalendarEvent(), createSetup(), firestoreValue(), getCalendarBusyIntervals(), getGoogleToken(), getSecret(), googleJson() (+13 more)
...
### Community 66 - "bing-fetch-api-key.mjs"
Cohesion: 0.19
Nodes (17): allowGenerate, main(), port, report, reportPath, root, siteQ, writeReport() (+9 more)
...
Cohesion: 0.10
Nodes (41): applyHeaderWeatherEqualMetricSpacing(), bindHeaderWeatherScrollContainment(), buildLanguageUrl(), clearHeaderWeatherOrbCanvas(), createHeaderMarkup(), drawHeaderWeatherOrbFrame(), extractSupportedLang(), fetchHeaderWeatherSourceTimeMs() (+33 more)
...
Cohesion: 0.20
Nodes (20): applyHeaderWeatherTransparency(), bindHeaderWeatherDropdownScrollState(), bindHeaderWeatherOutsideDismiss(), bindHeaderWeatherReadingsObserver(), bindHeaderWeatherState(), enforceHeaderWeatherToggleArrow(), enhanceHeaderWeatherCloudRenderer(), ensureHeaderWeatherToggleArrowBase() (+12 more)
...
### Community 77 - "fit-meta-descriptions.mjs"
Cohesion: 0.25
Nodes (7): bad, cleanBase(), CLOSE, fit(), next, report, root

### Community 78 - "expand-thin-pages.mjs"
Cohesion: 0.29
...
Cohesion: 0.16
Nodes (27): candidates, main(), main(), auditPagesDeploy(), auditToken(), GROUP_IDS, isDeployToken(), isFullToken (+19 more)

### Community 81 - "bing-wmt.mjs"
Cohesion: 0.08
Nodes (28): allowGenerate, ensureCdp(), main(), port, root, runNode(), listPath, matchesOrigin() (+20 more)
...
### Community 84 - "seo-generate.js"
Cohesion: 0.19
Nodes (20): assertAllowedOrigin(), sanitizeOrigin(), assertLocalePayload(), buildPrompt(), buildSnippets(), DEFAULT_SERVICE_GATEWAY_URL, escapeHtml(), getEnvVar() (+12 more)
...
Cohesion: 0.08
Nodes (19): failures, reports, routes, MIME_TYPES, resolveRequestPath(), startStaticTestServer(), consoleErrors, failedResponses (+11 more)

### Community 93 - "indexnow-submit.js"
Cohesion: 0.13
Nodes (11): apexList, getSitemapUrls(), isDryRun, key, keyPath, manualListPath, read(), root (+3 more)

### Community 94 - "lengthen-meta-descriptions.mjs"
Cohesion: 0.16
...
### Community 100 - "set-bing-api-key.mjs"
Cohesion: 0.33
...
Cohesion: 0.09
Nodes (36): addLocalMinutes(), ADMIN_EMAIL_COPY, BOOKING_BEHAVIOUR_EXTRA_MINUTES, BOOKING_BEHAVIOURS, BOOKING_CLIENT_TYPES, BOOKING_COAT_CONDITIONS, BOOKING_COAT_EXTRA_MINUTES, BOOKING_META_COPY (+28 more)
...
Cohesion: 0.29
Nodes (4): baseSources, catSources, locales, root
...
Cohesion: 0.14
Nodes (14): 1. Langhaarige Rassen ####, 2. Pudel, Bichons und Pudeltypen ####, 3. Spitze ####, 4. Spaniels ####, 5. Rauhaarige Rassen ####, 6. Canonical published price list ##, 6. Kurzhaarige Hunde ####, 7. Große Hunde #### (+6 more)
...
### Community 135 - "telegram-webhook.js"
Cohesion: 0.12
Nodes (27): answerTelegramCallbackQuery(), cleanText(), AUTO_REPLY_COPY, bookingUrl(), buildActionMarkup(), buildAutoReply(), buildClientReply(), buildMenuRemovalMarkup() (+19 more)
...
Cohesion: 0.15
Nodes (13): 1. Довгошерсті породи ####, 2. Пуделі, бішони та пудельні породи ####, 3. Шпіци ####, 4. Спанієлі ####, 5. Жорсткошерсті породи ####, 6. Короткошерсті собаки ####, 7. Великі собаки ####, UK — published catalog ### (+5 more)
...
### Community 174 - "bing-url-submit.mjs"
Cohesion: 0.26
Nodes (13): bingUrlListDigest(), classifyBingApiFailure(), defaultListPath, defaultStatePath, filterBingSubmissionUrls(), main(), planBingUrlSubmission(), readState() (+5 more)
...
### Community 176 - "subscribe.js"
Cohesion: 0.27
Nodes (10): getEnvList(), sendTelegramMessage(), siteNotificationsEnabled(), COPY, DEFAULT_ADMIN_EMAILS, isValidEmail(), NEWSLETTER_COPY, onRequest() (+2 more)
...
Cohesion: 0.08
Nodes (40): cdpReady(), child, ensureEdge(), pidFile, root, startEdge(), candidates, pidFile (+32 more)
...
### Community 198 - "bing-webmaster-complete.mjs"
Cohesion: 0.18
...
Cohesion: 0.17
Nodes (17): bootstrapViaDashboard(), TEMPLATE_URL, DEFAULT_PAGES_PROJECT, extractTokenFromText(), loadPagesDeployCredentials(), loadTokenFile(), PAGES_PERMISSION_KEYS, PAGES_TOKEN_FILE (+9 more)

### Community 202 - "generate-brand-sitemap.mjs"
Cohesion: 0.33
Nodes (5): brandPaths, out, root, today, urls

### Community 203 - "jsonResponse"
Cohesion: 0.15
Nodes (25): onRequest(), isWithinBookingHorizon(), normalizeBusyIntervals(), normalizeDate(), onRequestGet(), applyApiResponseHeaders(), applyCorsResponseHeaders(), enforceRateLimit() (+17 more)
...
### Community 206 - "upload.js"
Cohesion: 0.27
Nodes (12): hasValidPetPhotoSignature(), isAllowedPetPhotoType(), PET_PHOTO_ALLOWED_TYPES, PET_PHOTO_MAX_BYTES, PET_PHOTO_MAX_MB, petPhotoTooLarge(), bookingMetadata(), driveNotConfiguredResponse() (+4 more)

### Community 210 - "10. Границы ответов AI-помощника"
Cohesion: 0.40
Nodes (5): 10.1. Что бот может делать, 10.2. Что бот не может делать, 10.3. Правило языка клиента, 10.4. Шаблон безопасного ответа, 10. Границы ответов AI-помощника
...
### Community 215 - "bing-api.mjs"
Cohesion: 0.23
Nodes (7): getBingApiKey(), hasBingApiKey(), childEnv(), notifySlack(), npmCommand, runNpm(), probes

### Community 216 - "bing-finish-remaining.mjs"
Cohesion: 0.20
Nodes (7): out, port, report, root, siteQ, summary, withSession()

### Community 218 - "lg-task.js"
Cohesion: 0.42
...
### Community 228 - "accountTokenTemplateUrl"
Cohesion: 0.25
Nodes (8): unifiedTokenProfileTemplateUrl(), unifiedTokenTemplateUrl(), accountTokenTemplateUrl(), automationTokenTemplateUrl(), encodePermissionGroupKeys(), userTokenTemplateUrl(), fallbackUrl, url
...
### Community 233 - "bing-finish-manual.mjs"
Cohesion: 0.25
Nodes (7): out, port, report, root, siteQ, summary, BING_INDEXNOW_COVERAGE

### Community 235 - "weather-widget-smoke.mjs"
Cohesion: 0.40
Nodes (4): consoleErrors, failedRequests, host, sunScene404

### Community 236 - "overrides"
Cohesion: 0.33
Nodes (6): overrides, esbuild, fast-uri, sharp, undici, ws

### Community 237 - "discover-google-maps.mjs"
Cohesion: 0.33
Nodes (5): out, port, queries, results, root

### Community 238 - "browserslist"
Cohesion: 0.40
Nodes (5): browserslist, > 1%, last 2 versions, not dead, not ie <= 11

### Community 239 - "enhance-review-cta.mjs"
Cohesion: 0.40
Nodes (3): COPY, LINK, root
...
Cohesion: 0.16
Nodes (4): Inbox, Projects, Resources, {{title}}

### Community 390 - "Tasks/README.md"
Cohesion: 0.13
Nodes (12): Decision log, Open tasks, Routing source, Task Queue, Workflow, Areas, Codex workflow, Coverage (+4 more)

### Community 392 - "bing-webmaster-automate.mjs"
Cohesion: 0.28
Nodes (7): evaluate(), inspectHome(), listPath, port, priorityUrls, root, submitUrls()

### Community 564 - "update-animal-breed-photos.mjs"
Cohesion: 0.12
Nodes (32): candidates, chunks(), decodeHtml(), fetchJson(), fileTitleFromUrl(), followTitle(), genericBreedTokens, isBreedPage() (+24 more)
...
Cohesion: 0.18
Nodes (9): manifestPath, root, byKind, duplicatePhotoTitles, { records, uniqueRecords }, report, catalogSources, loadAnimalPhotoCatalog() (+1 more)

### Community 1133 - "normalizeAnimalPhotoKey"
Cohesion: 0.28
Nodes (9): cleanSlug(), generatedLookupKey(), normalizeAnimalPhotoKey(), entries, meaningfulTokens(), requestOpenversePhotoCandidates(), scoreCommonsPhoto(), scoreOpenversePhoto() (+1 more)
...
### Community 1283 - "Brand Assets"
Cohesion: 0.50
Nodes (4): Approved public identity, Asset rules, Brand Assets, Suggested asset log
...
### Community 1292 - "bing-consolidate-accounts.mjs"
Cohesion: 0.25
...
## Knowledge Gaps
- **1699 isolated node(s):** `FOOTER_COPY`, `NAV_COPY`, `THEME_COPY`, `LANGUAGE_COPY`, `SOCIAL_LINKS` (+1694 more)
...
- **Why does `sleep()` connect `sleep` to `bing-webmaster-complete.mjs`, `bing-webmaster-automate.mjs`, `cf-pages-token.mjs`, `seo-search-watch.mjs`, `discover-google-maps.mjs`, `local-citations-automate.mjs`, `google-oauth-console-bootstrap.mjs`, `bing-wmt.mjs`, `withCdpSession`, `stopTrackedBrowser`, `bing-sitescan.mjs`, `bing-sitescan-results.mjs`, `brand-profiles.mjs`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `siteNotificationsEnabled()` connect `subscribe.js` to `platform-integrations.js`, `getEnvValue`, `sendmail.js`, `bing-api.mjs`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `jsonResponse()` connect `jsonResponse` to `draft-service.js`, `api/ai-chat.js`, `sendmail.js`, `upload.js`, `subscribe.js`, `reverse-geocode.js`, `seo-generate.js`, `getEnvValue`, `lg-task.js`, `weather.js`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **What connects `FOOTER_COPY`, `NAV_COPY`, `THEME_COPY` to the rest of the system?**
