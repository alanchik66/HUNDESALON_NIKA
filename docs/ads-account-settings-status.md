...
| Кампании | Только **1** (PMax), статус **Приостановлено** |
...
| Ещё открыто | видео 0; sitelinks; больше landscape-фото; сигналы аудиторий |
...
- Website conversions слабые; согласие analytics: `ad_storage: denied` на сайте — отдельная задача для будущих лидов.
