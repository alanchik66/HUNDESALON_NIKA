...
`npm run deploy` uses **HUNDESALON_NIKA — Automation** (`CLOUDFLARE_API_TOKEN`): zone purge/DNS/rules + Pages deploy in one scoped token. See `docs/cloudflare-api-tokens.md`.
