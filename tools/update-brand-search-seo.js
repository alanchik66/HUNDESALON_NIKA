...
function buildBrandHeadBlock(indent) {
  ...
  return [
    ...
    `${indent}<link rel="icon" type="image/png" sizes="48x48" href="/assets/images/favicon/favicon-48x48.png?v=${v}">`,
    `${indent}<link rel="icon" type="image/png" sizes="64x64" href="/assets/images/favicon/favicon-64x64.png?v=${v}">`,
    `${indent}<link rel="icon" type="image/png" sizes="96x96" href="/assets/images/favicon/favicon-96x96.png?v=${v}">`,
    `${indent}<link rel="icon" type="image/png" sizes="128x128" href="/assets/images/favicon/favicon-128x128.png?v=${v}">`,
    `${indent}<link rel="icon" type="image/png" sizes="192x192" href="/assets/images/favicon/android-chrome-192x192.png?v=${v}">`,
    ...
    `${indent}<meta name="msapplication-TileImage" content="/assets/images/favicon/mstile-150x150.png?v=${v}">`,
