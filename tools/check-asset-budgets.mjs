...
const budgets = [
  ...
  // The modular stylesheet is minified in production. 25.5 KB gzip covers the
  // responsive booking and price modules while retaining a strict cap.
  { file: 'dist/assets/css/page-modules.css', gzip: 25_500 },
