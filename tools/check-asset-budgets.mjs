...
const budgets = [
  ...
  // The modular stylesheet is minified in production. The 30.5 KB cap tracks
  // the verified 30.1 KB grouped animal catalog and photo UI baseline with strict headroom.
  { file: 'dist/assets/css/page-modules.css', gzip: 30_500 },
