...
const budgets = [
  ...
  // Minified September 2026 baseline: 33.8 KB gzip, including shared booking
  // controls, responsive price cards and page scroll navigation. Keep 1.2 KB headroom.
  { file: 'dist/assets/css/page-modules.css', gzip: 35_000 },
