...
const fontStylesheet =
  'https://fonts.googleapis.com/css2?family=Cinzel:wght@400;500;600&family=Cormorant+Garamond:ital,wght@0,400;0,500;1,400;1,500&family=Forum&family=Great+Vibes&family=Marck+Script&display=swap';
const styleHref = '../assets/css/style.css?v=20260720-prod-v2';
const iconHref = '../assets/fonts/fontawesome/all.min.css?v=20260329-0192';
const pageModulesHref = '../assets/css/page-modules.css?v=20260720-prod-v2';
