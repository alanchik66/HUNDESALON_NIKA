...
const GOOGLE_ADS_URL =
  'https://ads.google.com/aw/overview?ocid=8415382946&workspaceId=0&ascid=8415382946&euid=6578015462&__u=7095037238&uscid=8415382946&__c=5110651154&authuser=0';
...
async function setupGoogleAds() {
  ...
  try {
    ...
    const createButton = page
      .locator(
        'button:has-text("New campaign"), button:has-text("Создать кампанию"), button:has-text("Kampagne erstellen")'
      )
      .first();
  ...
  // Диагностические снимки не должны попадать в корень или Git.
  const screenshotPath = 'test-results/google-ads-state.png';
