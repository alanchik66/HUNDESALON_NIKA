/**
 * Revert header weather 3D cloud tuning (restore pre-20260521 values).
 */
import fs from 'fs';
...
console.log('reverted Scene3D clouds');
...
for (const file of widgetFiles) {
  ...
  w = w.replace(
    'Scene3D-Cdhk74W6.mjs?v=20260521-weather-clouds-soft-1',
    'Scene3D-Cdhk74W6.mjs?v=20260504-weather-orbit3'
  );
