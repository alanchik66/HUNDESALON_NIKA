...
console.log(`   ${report.indexnow.apex} apex + ${report.indexnow.www} www → Bing Submit: ${urls.length} (квота 100/день)`);
...
report.bingSubmit = await withCdp(async send => {
...
report.wwwProperty = await withCdp(async send => {
