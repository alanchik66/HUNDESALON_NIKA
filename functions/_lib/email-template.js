...
<html lang="${locale}" dir="ltr">
  <head>
    ...
    <style>
      ...
      .hero { padding:12px 20px 18px; background:#07150d; color:#f5f0e6; text-align:left; }
      .logo { display:block; width:72px; height:72px; max-height:72px; object-fit:contain; margin:0; }
      ...
      @media screen and (max-width:600px) {
        .email-pad { padding:0 8px 12px !important; }
        .hero { padding:10px 14px 16px !important; }
        .brand-cell { width:84px !important; text-align:left !important; }
        .nav-cell { text-align:right !important; }
        .logo { width:72px !important; height:72px !important; max-height:72px !important; margin:0 !important; }
        .nav-link { margin:3px !important; }
        .booking-link { margin:0 !important; padding:10px 12px !important; font-size:10px !important; white-space:normal !important; }
  ...
  <body style="margin:0;padding:0;background-color:#010301;color:#ece8df;">
    ...
    <table role="presentation" class="email-bg" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#010301" style="width:100%;background-color:#010301;background-image:linear-gradient(145deg,#041006 0%,#010301 48%,#020806 100%);">
      <tr><td class="email-bg email-pad" align="center" valign="top" bgcolor="#010301" style="padding:0 14px 16px;background-color:#010301;">
        <table role="presentation" class="shell card" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#060b09" style="width:100%;max-width:680px;background-color:#060b09;border:1px solid #d6e7dc1f;border-radius:22px;overflow:hidden;">
          <tr><td class="hero" bgcolor="#07150d" style="padding:12px 20px 18px;background-color:#07150d;color:#f5f0e6;text-align:left;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;"><tr>
              <td class="brand-cell" width="84" valign="middle" style="width:84px;vertical-align:middle;"><img class="logo" src="${LOGO_URL}" width="72" height="72" alt="HUNDESALON_NIKA" style="display:block;width:72px;height:72px;max-height:72px;object-fit:contain;margin:0;"></td>
              <td class="nav-cell" align="right" valign="middle" style="text-align:right;vertical-align:middle;font-size:0;"><a class="booking-link" href="${SITE_URL}/${locale}/onlayn-bronirovanie.html" style="position:relative;display:inline-block;overflow:hidden;margin:0;padding:11px 18px;border:0;border-radius:11px;background-color:#13251a;background-image:radial-gradient(ellipse at 30% 0%,rgba(255,255,255,.12) 0%,rgba(255,255,255,0) 60%),linear-gradient(105deg,rgba(255,255,255,0) 0%,rgba(255,246,215,.08) 30%,rgba(255,246,215,.28) 50%,rgba(255,255,255,0) 70%);background-position:0 0,45% 50%;background-size:100% 100%,260% 180%;color:#efc866;font-family:Georgia,'Times New Roman',serif;font-size:11px;font-weight:700;letter-spacing:.7px;line-height:1.2;text-decoration:none;text-shadow:0 1px 0 #683907;box-shadow:0 4px 20px rgba(0,0,0,.12),inset 0 .5px 0 rgba(255,255,255,.05);white-space:nowrap;">${escapeHtml(navCopy.booking)}</a></td>
            </tr><tr><td colspan="2" class="header-navigation" style="padding-top:8px;text-align:left;font-size:0;">${navigation}</td></tr></table>
            <div class="eyebrow" style="margin-top:14px;color:#e4bd63;font-size:11px;font-weight:700;letter-spacing:2px;line-height:1.4;text-transform:uppercase;">${footer.eyebrow}</div>
          ...
          <tr><td class="footer" bgcolor="#060b09" style="padding:20px 32px 24px;background-color:#060b09;border-top:1px solid #d6e7dc1f;color:#aab8b1;font-size:12px;"><a href="${SITE_URL}" style="color:#e4bd63;font-weight:700;text-decoration:none;">HUNDESALON_NIKA</a><br>${footer.address}: Untere Eichstädtstraße 38 · 04299 Leipzig<br>${footer.reply}</td></tr>
